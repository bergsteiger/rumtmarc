...
uses
  ...
  {$If not defined(NoScripts) AND not defined(NoVCM)}
  ,
  kwVcmOpEnabled in 'w:\common\components\rtl\Garant\ScriptEngine\kwVcmOpEnabled.pas'
  {$IfEnd} //not NoScripts AND not NoVCM
  
  {$If not defined(NoScripts) AND not defined(NoVCM)}
  ,
  kwVcmOpVisible in 'w:\common\components\rtl\Garant\ScriptEngine\kwVcmOpVisible.pas'
  {$IfEnd} //not NoScripts AND not NoVCM
  
  {$If not defined(NoScripts) AND not defined(NoVCM)}
  ,
  kwVcmOpChecked in 'w:\common\components\rtl\Garant\ScriptEngine\kwVcmOpChecked.pas'
  {$IfEnd} //not NoScripts AND not NoVCM
  
  {$If not defined(NoScripts) AND not defined(NoVCM)}
  ,
  kwVcmOpDefault in 'w:\common\components\rtl\Garant\ScriptEngine\kwVcmOpDefault.pas'
  {$IfEnd} //not NoScripts AND not NoVCM
  
  {$If not defined(NoScripts) AND not defined(NoVCM)}
  ,
  kwVcmOpCaption in 'w:\common\components\rtl\Garant\ScriptEngine\kwVcmOpCaption.pas'
  {$IfEnd} //not NoScripts AND not NoVCM
  
  {$If not defined(NoScripts) AND not defined(NoVCM)}
  ,
  kwVcmOpHint in 'w:\common\components\rtl\Garant\ScriptEngine\kwVcmOpHint.pas'
  {$IfEnd} //not NoScripts AND not NoVCM
  
  {$If not defined(NoScripts) AND not defined(NoVCM)}
  ,
  kwVcmOpImageIndex in 'w:\common\components\rtl\Garant\ScriptEngine\kwVcmOpImageIndex.pas'
  {$IfEnd} //not NoScripts AND not NoVCM
  
  {$If not defined(NoScripts) AND not defined(NoVCM)}
  ,
  kwVcmOpShortcut in 'w:\common\components\rtl\Garant\ScriptEngine\kwVcmOpShortcut.pas'
  {$IfEnd} //not NoScripts AND not NoVCM
  
  {$If not defined(NoScripts) AND not defined(NoVCM)}
  ,
  kwVcmOpLongHint in 'w:\common\components\rtl\Garant\ScriptEngine\kwVcmOpLongHint.pas'
  {$IfEnd} //not NoScripts AND not NoVCM
