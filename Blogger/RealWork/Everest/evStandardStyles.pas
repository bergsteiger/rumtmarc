...
type
 ...
 _evStyleTableListner_Parent_ = Tl3ProtoObject;
 {$Include ..\Everest\evStyleTableListner.imp.pas}
 TevStandardStyles = class(_evStyleTableListner_, IafwFontCache)
  {* Стандартные стили }
 private
 // private fields
 ...
 // private methods
   procedure FreeFonts;
   procedure CheckFontInCache(const anObj: InevTag;
     anID: Integer;
     aJust: Boolean;
     aVis: Boolean;
     aFixedFont: Boolean;
 ...
 public
 // public methods
   function GetStandardStyleFont(const aPara: InevTag;
     aFixedFont: Boolean;
     out theFont: IevResultFont): Boolean;
   function GetStyleFont(const aStyle: InevTag;
...
procedure TevStandardStyles.CheckFontInCache(const anObj: InevTag;
  anID: Integer;
  aJust: Boolean;
  aVis: Boolean;
  aFixedFont: Boolean;
...
function TevStandardStyles.GetStandardStyleFont(const aPara: InevTag;
  aFixedFont: Boolean;
  out theFont: IevResultFont): Boolean;
...
function TevStandardStyles.GetStyleFont(const aStyle: InevTag;
  aPrinting: Boolean): IevResultFont;
...
//#UC START# *4E5F9A5E02A3_4E54CF7E0143_impl*
 CheckFontInCache(aStyle,
                  ...
                  aPrinting AND TevStyleInterface.DocumentUseFixedFontForPrintAndExportSetting,
                  Result);
