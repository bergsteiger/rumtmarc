...
//#UC START# *4F4C6F8902DF_4F4C6B940246get_impl*
 Result := Para.Child[ColumnID - 1].IntA[k2_tiWidth];
...
//#UC START# *4BBC947B0399_4F4C6B940246_impl*
 Result := ParaInst.OwnerPara.ChildrenCount;
...
function TevColumn.pm_GetProcessor: Ik2Processor;
