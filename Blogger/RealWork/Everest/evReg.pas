...
{ Ѕиблиотека ""         }
{ јвтор: Ћюлин ј.¬.     }
{ ћодуль: evReg - модуль дл€ регистрации визуальных компонент}
{ Ќачат: 20.03.97 18:59 }
{ $Id: evReg.pas,v 1.43 2009/07/24 08:04:15 oman Exp $ }
...
// - сделана возможность дл€ каждого сло€ отдельно указывать список иконок.
//
...
// - вс€ логика из TeePreviewPanel переехала в TevCustomPreviewPanel.
//
...
// - навел подобие пор€дка с регистрацией компонент библиотеки.
//
// Revision 1.33  2004/06/30 12:16:03  mmorozov
// new: регистраци€ TevLabel;
//
...
// - new behavior: сделана возможность определени€ парамеров операций по умолчанию.
//
// Revision 1.15  2001/10/04 08:05:52  law
// - new behavior: сделана возмозность определени€ парамеров операций по умолчанию.
//
...
// ƒобавили класс TevHyperlinkReplacer
//
...
uses
  ...
  evdSchema, // - определ€ет метаформат документов EVD
