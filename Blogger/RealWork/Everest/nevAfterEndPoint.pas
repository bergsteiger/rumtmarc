...
//#UC START# *49DF51870234_47F6036500E3_impl*
 ...
 begin
  Assert(ParaX.IsSame(aPoint.Obj^));
...
procedure TnevAfterEndPoint.DisableListner;
...
end;//TnevAfterEndPoint.DisableListner

procedure TnevAfterEndPoint.EnableListner;
...
end;//TnevAfterEndPoint.EnableListner
...
function TnevAfterEndPoint.Get_Listner: InevPointListner;
...
end;//TnevAfterEndPoint.Get_Listner
