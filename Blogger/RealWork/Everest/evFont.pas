...
{ $Id: evFont.pas,v 1.105 2009/07/02 17:42:26 lulin Exp $ }
...
procedure TevFont.SetParam(Index: Long; const Source: Ik2Tag);
  {override;}
  {-}
begin
 Case Index of
  ...
  k2_tiName:
   f_Font.Name := (Source.AsObject As Tl3CustomString).AsString;
  else
