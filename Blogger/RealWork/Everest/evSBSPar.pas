...
{ $Id: evSBSPar.pas,v 1.27 2010/04/12 15:36:59 lulin Exp $ }
...
function  evSBS_LeftColumn(const aSBS: Ik2Tag): Ik2Tag;
  {-}
function  evSBS_RightColumn(const aSBS: Ik2Tag): Ik2Tag;
  {-}
function  evSBS_LeftPara(const aSBS: Ik2Tag): Ik2Tag;
  {-}
function  evSBS_RightPara(const aSBS: Ik2Tag): Ik2Tag;
  {-}
procedure evSBS_Init(const aSBS : Ik2Tag;
                         aWidth     : Long = 0);
  {-}
...
begin
 ...
 begin
  ...
  if aSBS.QT(InevTable, l_TableTool) then
   l_TableTool.AddRow(nil, 2, aWidth div 2, False)
  else
