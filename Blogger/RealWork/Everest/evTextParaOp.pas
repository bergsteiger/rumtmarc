...
{ $Id: evTextParaOp.pas,v 1.39 2012/04/20 14:56:33 lulin Exp $ }
...
constructor OevInsertString.Create(const aPara : Ik2Tag;
                                   aPos        : Long;
                                   aSt         : Tl3CustomString);
  {virtual;}
  {-}
...
constructor TevOpJoinParas.Create(const aPara   : Ik2Tag;
                                  const aSecond : Ik2Tag);
  {-}
begin
 inherited Create(aPara);
 f_SecondPara := aSecond;
end;
