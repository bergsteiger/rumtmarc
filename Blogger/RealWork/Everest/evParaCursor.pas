...
//#UC START# *4A38AA9702EC_49DE22650362_impl*
 ...
 if not GetRedirect.TagType.Prop[aType].ReadOnly then
 begin
...
//#UC START# *47C689AE016E_49DE22650362_impl*
 ...
 begin
  ...
  l_I := Self.GetInner;
  if (l_I <> nil) AND l_I.Obj.IsValid then
  begin
...
function TevParaCursor.DoGetStyle(Stop: PInteger): InevTag;
...
//#UC START# *4A2945060101_49DE22650362_impl*
 l_CP := Self.GetInner;
 if (l_CP <> nil) and not l_CP.AfterEnd then
...
//#UC START# *4A29465701BC_49DE22650362_impl*
 if GetRedirect.IsSame(aMarker.Para) then
 begin
