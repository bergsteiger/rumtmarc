...
//#UC START# *4A3FA3CC00CC_4A3FA3290296_impl*
 ...
 begin
  case aExpandMode of
   l3_bUnknown:
    l_Value := not ParaX.BoolA[k2_tiCollapsed];
   l3_bTrue:
    l_Value := False;
   l3_bFalse:
    l_Value := True;
  ...
  ParaX.BoolW[k2_tiCollapsed, k2StartOp(aView.Control.Processor)] := l_Value;
...
//#UC START# *4A60B23E00C3_4A3FA3290296_impl*
 ...
 begin
  ...
  if (l_SubList <> nil) then
   try
    Result.SetOk;
    IevSub(Obj) := l_SubList.SubEx[ParaX.rLong(k2_tiHandle, -1),
                                   ParaX.rLong(k2_tiLayerID, ev_sbtSub)];
...
//#UC START# *4AA785540310_4A3FA3290296_impl*
 ...
 begin
  if aPoint.BoolA[k2_tiCollapsed] and ParaX.BoolA[k2_tiCollapsed] then
   Result := 0;
