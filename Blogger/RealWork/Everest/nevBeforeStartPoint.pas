...
procedure TnevBeforeStartPoint.DisableListner;
...
end;//TnevBeforeStartPoint.DisableListner

procedure TnevBeforeStartPoint.EnableListner;
...
end;//TnevBeforeStartPoint.EnableListner
...
function TnevBeforeStartPoint.Get_Listner: InevPointListner;
...
end;//TnevBeforeStartPoint.Get_Listner
