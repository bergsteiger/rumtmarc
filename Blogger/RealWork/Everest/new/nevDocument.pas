...
{ $Id: nevDocument.pas,v 1.17 2011/09/01 13:44:30 lulin Exp $ }
...
function TnevDocument.GetDocumentContainer: InevDocumentContainer;
  ...
  {-}
begin
 if not OwnerTag.Box.GetOwnInterface(InevDocumentContainer, Result) then
...
function TnevDocument.GetHolder: InevObjectHolder;
  ...
  {-}
begin
 if not OwnerTag.Box.GetOwnInterface(InevObjectHolder, Result) then
