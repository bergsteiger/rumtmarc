...
type
 ...
 // protected methods
   ...
   function GetOwnerTag: InevTag; virtual;
...
function TnevParaPrim.GetOwnerTag: InevTag;
...
constructor TnevParaPrim.Create(const aTag: InevTag);
...
//#UC START# *47C698710396_48CE0A490377_impl*
 if QT(InevRangeFactory, l_Sel) then
  try
   ...
   begin
    Assert((aStart = nil) OR Self.IsSame(aStart.Obj^.Box));
    Assert((aFinish = nil) OR Self.IsSame(aFinish.Obj^.Box));
...
//#UC START# *47C698CF0004_48CE0A490377_impl*
 if not CloneTag.QT(InevObject, Result) then
  Assert(false);
...
function TnevParaPrim.OwnerTag: InevTag;
...
//#UC START# *47C6A6F20262_48CE0A490377_impl*
 Result := (IntA[k2_tiStyle] = ev_saTxtComment) OR (IntA[k2_tiStyle] = ev_saContents);
...
//#UC START# *48E0CBBD0016_48CE0A490377get_impl*
 ...
 begin
  with Attr[k2_tiStyle].Attr[k2_tiFont] do
  begin
...
//#UC START# *4B7BDCA502F7_48CE0A490377_impl*
 Result := IsComment OR (IntA[k2_tiStyle] = ev_saVersionInfo);
...
//#UC START# *4E1AFECA025B_48CE0A490377_impl*
 with Box.Owner.TagType do
  Result := InheritsFrom(k2_idTextStyle_Header) OR
            InheritsFrom(k2_idTextStyle_Footer);
//#UC END# *4E1AFECA025B_48CE0A490377_impl*
end;//TnevParaPrim.IsDecorationElement

function TnevParaPrim.DecorObj(aType: TnevDecorType): InevTag;
//#UC START# *4E243EF60356_48CE0A490377_var*
const
 cMap : array [TnevDecorType] of Integer = (k2_tiHeader, k2_tiFooter);
