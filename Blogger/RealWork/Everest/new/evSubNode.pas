...
{ $Id: evSubNode.pas,v 1.2 2010/03/02 13:34:40 lulin Exp $ }
...
constructor TevSubNode.Create(const aTagWrap : Ik2Tag;
                              const aPara    : Ik2Tag;
                              aLayerID       : Long);
  {reintroduce;}
  {-}
...
class function TevSubNode.Make(const aTagWrap : Ik2Tag;
                               const aPara    : Ik2Tag;
                               aLayerID       : Long): Il3Node;
  {-}
var
...
function TevSubNode.pm_GetDocument: Ik2Tag;
  //override;
  {-}
var  
 l_Tag : Ik2Tag;
