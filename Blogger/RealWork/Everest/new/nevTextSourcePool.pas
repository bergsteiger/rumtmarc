...
{ $Id: nevTextSourcePool.pas,v 1.24 2011/07/20 11:15:53 lulin Exp $ }
...
type
  TnevTextSourcePool = class(Tl3Base,
                             InevTextSourcePool,
                             IevSubCache,
                             Il3Lock,
                             InevViewArea)
...
(*      function  pm_GetTypeTable: Ik2TypeTable;
      ...
      function  CastAnyEditorTo(const IID : TGUID;
                                out theObj): Boolean;
        {-}
      procedure DocumentChanged(const anOldDocument, aNewDocument : Ik2Tag);
        {-}
...
function TnevTextSourcePool.Get_Document: Ik2Tag;
  {-}
begin
 if (f_Containter = nil) then
  Result := nil
...
procedure TnevTextSourcePool.DocumentChanged(const anOldDocument, aNewDocument : Ik2Tag);
  {-}
var
 l_Index : Integer;
begin
