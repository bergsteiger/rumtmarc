...
type
 ...
 public
 // public methods
   constructor Create(const aTabStops: InevTag); reintroduce;
   class function Make(const aTabStopsHolder: InevTag): Il3TabStops;
 end;//TevTabStops
...
constructor TevTabStops.Create(const aTabStops: InevTag);
...
class function TevTabStops.Make(const aTabStopsHolder: InevTag): Il3TabStops;
...
//#UC START# *48D1067302B6_48D1055203B8_impl*
 ...
 if l_ATabStops.IsValid then begin
...
//#UC START# *4728A3F5019F_48D1055203B8_impl*
 if (f_Index < 0) then begin
  ...
  if (f_Index < f_TabStops.ChildrenCount) then begin
