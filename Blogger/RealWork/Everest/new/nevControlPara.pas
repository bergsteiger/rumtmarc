...
type
 ...
 public
 // public methods
   class function Make(const aTag: InevTag): IevControlFriend; reintroduce;
 end;//TnevControlPara
...
class function TnevControlPara.Make(const aTag: InevTag): IevControlFriend;
var
...
//#UC START# *4D7255870102_48D11BE0015E_impl*
 ...
 if l3IsNil(Result) AND (Get_ControlType = ev_ctMemoEdit) then
