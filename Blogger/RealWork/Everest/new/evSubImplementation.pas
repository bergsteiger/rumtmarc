...
// - убрано прямое создание через Create.
//
...
// - new behavior: TevSubImplementation и TevDocumentPartImplementation теперь кешируются.
//
...
// - new behavior: TevDocumentPartImplementation теперь отдает интерфейс IevDocument (если является документом).
//
