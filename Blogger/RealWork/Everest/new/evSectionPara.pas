...
{ $Id: evSectionPara.pas,v 1.1 2009/09/14 11:28:04 lulin Exp $ }
...
function evGetPaperSize(const aParas: Ik2Tag): TevdPaperSize;
  overload;
  {-}
function evGetPaperSize(const aSize: Tl3Point): TevdPaperSize;
  overload;
  {-}
function evGetPaperSizeName(const aParas: Ik2Tag): String;
  overload;
  {-}
function evGetPaperSizeName(const aSize: Tl3Point): String;
  overload;
  {-}
function evSectionExtent(const aPara: Ik2Tag): Tl3Point;
  { - размеры раздела }
