...
{ $Id: evAnchorIndex_Impl.pas,v 1.32 2009/07/23 13:42:10 lulin Exp $ }

// $Log: evAnchorIndex_Impl.pas,v $
...
type
  TevDocumentAnchorIndex = class(Tk2ProcTagTool, IevAnchorIndex)
   {* Реализация индекса точек входа. }
    ...
    public
    // public methods
      class function Make(const aTarget    : Ik2Tag;
...
class function TevDocumentAnchorIndex.Make(const aTarget    : Ik2Tag;
                                           const aProcessor : Ik2Processor): IevAnchorIndex;
  //reintroduce;
  {* - создать интерфейс IevAnchorIndex. }
var
