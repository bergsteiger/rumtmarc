...
{ $Id: evAutoComplete.pas,v 1.24 2009/07/23 13:42:10 lulin Exp $}
...
type
 ...
 public
  constructor Create(aOwner: TObject = nil; aFileName: string = ''); reintroduce;
...
constructor TevAutoComplete.Create(aOwner: TObject = nil; aFileName: string = '');
begin
