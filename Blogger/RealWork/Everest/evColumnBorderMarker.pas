...
procedure TevColumnBorderMarker.Assign(Source: TPersistent);
//#UC START# *478CF34E02CE_4E3A539401D7_var*
//#UC END# *478CF34E02CE_4E3A539401D7_var*
begin
//#UC START# *478CF34E02CE_4E3A539401D7_impl*
 inherited;
 if (Source Is TevColumnBorderMarker) then
  f_ColumnID := TevColumnBorderMarker(Source).f_ColumnID;
//#UC END# *478CF34E02CE_4E3A539401D7_impl*
...
//#UC START# *4E3A4C4B03A0_4E3A539401D7_impl*
 ...
 begin
  ...
  for i := 1 to Min(ParaCount, f_ColumnID) do
   Inc(Result, Para[i - 1].IntA[k2_tiWidth]); 
 end;//with ParaX
