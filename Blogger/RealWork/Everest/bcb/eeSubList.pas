...
{ $Id: eeSubList.pas,v 1.24 2010/02/11 13:45:28 lulin Exp $ }
...
constructor TeeSubList.Create(const aTagWrap   : Ik2Tag;
                              const aDocument  : IeeDocumentEx;
                              aHandle          : Integer;
                              const aProcessor : InevProcessor);
  //reintroduce;
...
class function TeeSubList.Make(const aTagWrap   : Ik2Tag;
                               const aDocument  : IeeDocumentEx;
                               aHandle          : Integer;
                               const aProcessor : InevProcessor = nil): IeeSubList;
  {-}
...
function TeeSubList.Get_Sub(anIndex: Integer): IeeSub;
  {-}
var
 l_Child : Ik2Tag;
begin
...
function TeeSubList.Get_SubByID(anID: Integer): IeeSub;
  {-}
begin
...
var
 ...
 l_Sub : IevSub;
begin
 if (TagInst = nil) OR TagInst.InheritsFrom(k2_idDocument) then
