...
initialization
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\gui\Garant\Everest\bcb\eeShortCutEdit.pas initialization enter'); {$EndIf}
...
{!touched!}{$IfDef LogInit} WriteLn('W:\common\components\gui\Garant\Everest\bcb\eeShortCutEdit.pas initialization leave'); {$EndIf}
finalization
