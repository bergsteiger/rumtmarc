...
{ $Id: eeReg.pas,v 1.34 2013/01/22 15:51:58 kostitsin Exp $ }
...
// - new event: OnDocumentChanged - сделана возможность узнавать о смене документа в TextSource.
//
...
begin
 ...
 RegisterComponents(evEverestPage, [TeeEditor, TeeEditorWithoutOperations,
  TeeSubPanel, TeeTreeView, TeeMemoWithEditOperations, TeePreviewPanel, TeeCheckBox,
  TeeButton, TeeBitBtn, TeeRadioButton,
  TeeShortCutEdit, TeeGroupBox]);
 RegisterComponents(evEverestPage, [TvtPanel]);
 RegisterComponents(evEverestComponentsPage, [TeeTextSource, TeeSubDescriptors]);
