...
{ $Id: eeBaseInterfaces.pas,v 1.18 2011/07/18 15:45:24 lulin Exp $ }
...
// - new methods: IeeGenerator.StartDefaultChild, AddTransparentAtom.
...
// - new methods: IeeGenerator.AddStreamAtom, IeeGenerator.AddMemAtom.
//
