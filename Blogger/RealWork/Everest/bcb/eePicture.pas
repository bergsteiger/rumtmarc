...
{ $Id: eePicture.pas,v 1.6 2009/04/06 17:51:28 lulin Exp $ }
...
type
  TeePicture = class(TeePara, IeePicture)
    ...
    // interface methods
      // IeePicture
      function  IeePicture.pm_GetName = IeePicture_pm_GetName;
      function  IeePicture_pm_GetName: Il3CString;
        {-}
...
function TeePicture.IeePicture_pm_GetName: Il3CString;
  {-}
begin
