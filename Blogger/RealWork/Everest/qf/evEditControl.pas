...
type
 ...
 // realized methods
   ...
   function AnalysString(const aValue: Il3CString;
    ...
    out aRslt: Il3CString): Boolean;
     {* Анализ добавленной строки, если нужно, то убирает лишние символы или 
          разбивает строку на несколько. }
 ...
 // protected methods
   ...
   function DoAnalysString(const aValue: Il3CString;
    aPos: Integer;
...
function TevEditControl.DoAnalysString(const aValue: Il3CString;
  aPos: Integer;
  out aRslt: Il3CString): Boolean;
...
end;//TevEditControl.DoAnalysString
...
function TevEditControl.AnalysString(const aValue: Il3CString;
  aPos: Integer;
  out aRslt: Il3CString): Boolean;
...
//#UC START# *47CD7AD60335_48D2409102B7_impl*
 Result := DoAnalysString(aValue, aPos, aRslt);
//#UC END# *47CD7AD60335_48D2409102B7_impl*
end;//TevEditControl.AnalysString
