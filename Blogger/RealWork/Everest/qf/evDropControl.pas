...
//#UC START# *48D37B8500D3_48D367B20014_impl*
 ...
 begin
  ...
  l_SpaceAfter := (Para.IntA[k2_tiSpaceAfter] div 2);
 ...
 with Para do
  if ((aDropPoint.Y + DropControlHeigth) > Screen.Height) and
   ...
   begin
    aInvert := True;
    l_SpacesTop := l3Point(aPt0.X, aPt0.Y + Para.IntA[k2_tiSpaceAfter]);
    aDropPoint := DocumentToScreen(l_SpacesTop);
    aDropPoint.Y := aDropPoint.Y + 2;
...
//#UC START# *48D37D94002E_48D367B20014_impl*
 Result := (aPt.X > aMap.FI.Width) and (aPt.X < (aMap.FI.Width + Para.IntA[k2_tiRightIndent]));
...
//#UC START# *47CE9F040044_48D367B20014_impl*
 Result := DropContainer.KeyDown(aView, Msg, Para);
