...
type
 ...
 IevModelListner = interface;
 { - предварительное описание IevModelListner. }
 ...
 IevEditorControl = interface(IevCustomEditorControl)
  {* От интерфейса InevInputListner }
 ...
 IevModelListner = interface(InevBase)
...
У Димы - Get_Checked/Set_Checked. }
 ...
 IevReq = interface(IevCustomParaTool)
   ...
   property ModelListner: IevModelListner
     read Get_ModelListner;
