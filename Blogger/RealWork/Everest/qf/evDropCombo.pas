...
(* function FindCurrent(const aTree : InevSimpleTree;
 ...
 begin//lp_SelectTail
  ...
  Assert(aSelection.Point.MostInner.IsSame(Self.Para));
...
//#UC START# *48D3A7710129_48D399A20288_impl*
 ...
 begin
  ...
  begin
   ...
   begin
    l_Text := Para.PCharLenA[k2_tiText];
...
//#UC START# *47CD7CA301A9_48D399A20288get_impl*
 ...
 if (l_Req = nil) then
  ...
  Supports(l_Req.Para[k2_tiDefaultNode], InevSimpleNode, Result);
...
//#UC START# *47CEA0F901D9_48D399A20288get_impl*
 ...
 if (l_Req = nil) then
  ...
  Result := l_Req.Para.BoolA[k2_tiNumList];
...
function TevDropCombo.DoAnalysString(const aValue: Il3CString;
  aPos: Integer;
...
//#UC START# *48D24F5F02BF_48D399A20288_impl*
 ...
 if (Get_Req.Para.BoolA[k2_tiNumList] and f_IsAsterisk) then
 begin
  Result := True;
  if f_IsAsterisk then
   if l3Same(aValue, cZ) then
 ...
 if ComboReq.IsContext then
  Result := Get_Req.AnalysString(aValue, aRslt);
//#UC END# *48D24F5F02BF_48D399A20288_impl*
end;//TevDropCombo.DoAnalysString
