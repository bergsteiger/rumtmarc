...
//#UC START# *47CD79C903AF_48D230A600EE_impl*
 ...
 begin
  if (Para.IntA[k2_tiStateIndex] = -1) then
   if (Para.IntA[k2_tiImageIndex] <> -1) then
    l_Long := Para.IntA[k2_tiImageIndex]
   else
    l_Long := -1
  else
    l_Long := Para.IntA[k2_tiStateIndex];
  if l_Long <> -1 then
   if l_Long = 5 then
    Result := ev_btDelete
  else 
...
//#UC START# *47CD79ED01CC_48D230A600EEget_impl*
 Result := Para.IntA[k2_tiStateCount];
...
//#UC START# *47CD79FA004E_48D230A600EEset_impl*
 Para.IntW[k2_tiStateIndex, nil] := aValue;
...
//#UC START# *47CD7A0A03DD_48D230A600EEget_impl*
 Result := Para.IntA[k2_tiImageIndex];
