...
procedure TevDropCalendarControl.AnalysText;
...
end;//TevDropCalendarControl.AnalysText
...
function TevDropCalendarControl.DoAnalysString(const aValue: Il3CString;
  aPos: Integer;
...
end;//TevDropCalendarControl.DoAnalysString
