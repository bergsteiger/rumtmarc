...
//#UC START# *499985C40249_49997D89034Eget_impl*
  Result := Cursor.MostInner.Obj.StrA[k2_tiType];
...
//#UC START# *4999A08E01C9_49997D89034Eget_impl*
  Result := Cursor.MostInner.Obj.StrA[k2_tiName];
...
//#UC START# *4999A09D0016_49997D89034Eget_impl*
  Result := Cursor.MostInner.Obj.StrA[k2_tiShortName];
...
//#UC START# *4999A0A60316_49997D89034Eget_impl*
  Result := Cursor.MostInner.Obj.StrA[k2_tiText];
...
//#UC START# *4999A0B201AF_49997D89034Eget_impl*
  Result := Cursor.MostInner.Obj.OwnerObj.OwnerObj.StrA[k2_tiReqID];
...
//#UC START# *4999A10101CF_49997D89034Eget_impl*
  Result := Cursor.MostInner.Obj.OwnerObj.StrA[k2_tiText];
...
//#UC START# *4999A10C005F_49997D89034Eget_impl*
  Result := Cursor.MostInner.Obj.IntA[k2_tiStateIndex] - Cursor.MostInner.Obj.IntA[k2_tiImageIndex];
