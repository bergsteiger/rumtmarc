...
{ $Id: evParaPackOperation.pas,v 1.14 2009/07/23 13:42:11 lulin Exp $ }
...
type  
  Ok2AddChildren = class(Tk2AtomOperation)
    ...
    // public methods
      ...
      function  SetParam(const List : Ik2Tag;
...
function Ok2AddChildren.SetParam(const List : Ik2Tag;
                                 const Prop : Tk2CustomPropertyPrim;
                                  Index     : Long): Ok2AddChildren;
  {-}
begin
 inherited SetParam(List, Prop);
 f_Deleted := Tk2TagList.Make;
 f_Index := Index;
 Result := Self;
end;
