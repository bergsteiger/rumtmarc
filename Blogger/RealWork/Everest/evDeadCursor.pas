...
{ $Id: evDeadCursor.pas,v 1.28 2009/07/13 12:31:36 lulin Exp $ }
...
type
  TevDeadCursor = class(Tl3Base, IevSavedCursor)
    private
    // property fields
      f_Position : Long;
    protected
    ...
    public
    // public methods
      class function Make: IevSavedCursor;
        reintroduce;
        {-}
...
class function TevDeadCursor.Make: IevSavedCursor;
  //reintroduce;
  {-}
var
...
begin
 ...
 begin
  if aPoint.Inner.Obj.QT(IevSavedCursor, C) then
   try
