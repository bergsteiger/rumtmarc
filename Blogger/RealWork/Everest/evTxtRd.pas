...
{ $Id: evTxtRd.pas,v 1.32 2012/02/29 09:09:44 lulin Exp $ }
...
procedure TevOutPara.AddTextPara(Generator: Tk2TagGenerator);
  {-}
begin
 Generator.StartChild(k2_idTextPara); {-открываем текстовый параграф}
 try
  Text.RTrim;
