...
//#UC END# *4BAA60370285__var*
begin
//#UC START# *4BAA60370285__impl*
 if (Blocks <> nil) then
  Result := Blocks.IterateAllF(l3L2IA(@l_StoreSel))
 else
  Result := -1;
//#UC END# *4BAA60370285__impl*
end;//TevLeafParaMultiSelectionBlock.Iterate

class function TevLeafParaMultiSelectionBlock.Make(const aTagWrap: InevTag;
