 ...
 Case Msg.CharCode of
  ...
  vk_Return: begin
   if l3System.Keyboard.Key[vk_Menu].Down AND
      l3System.Keyboard.Key[vk_Control].Down then begin
    if InPara(k2_idTable, l_BlockCursor) OR
       InPara(k2_idBlock, l_BlockCursor) then            
    begin
      ...
      try
       try
        if evInsertPara(l_OpPack,
                        l_BlockCursorParent,
                        Tk2Type(l_BlockCursorParent.Obj.TagType).ArrayProp[k2_tiChildren].DefaultChildType.MakeTag,
