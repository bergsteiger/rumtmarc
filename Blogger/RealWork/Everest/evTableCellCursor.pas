...
var
 ...
 begin
  ...
  begin
   if l_TablePoint.HasInner and not l_TablePoint.Inner.IsSame(l_RowPoint) then
   ...
   begin
    ...
    begin
     ...
     Result := l_Point.IntA[k2_tiMergeStatus] <> Ord(ev_msContinue);
    end;
...
//#UC START# *4D5D161A030C_50DACE1F0334_impl*
 ...
 if aPara = nil then
 begin
  if HasInner and (GetInner.StrA[k2_tiText] <> '') then
