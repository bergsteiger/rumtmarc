...
{ $Id: evUserCommentFilter.pas,v 1.7 2011/02/25 17:20:56 lulin Exp $ }
...
procedure TevUserCommentFilter.DoFlushBuffer(const aLeaf: Ik2Tag; aTagId: Integer; aNeedCloseBracket : Boolean);
  //virtual;
  {-}
begin
 StartCommentPara;
 aLeaf.Write(Generator, [l3_spfChildren]);
