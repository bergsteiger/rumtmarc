...
{ $Id: evOptimizedContext.pas,v 1.42 2012/04/20 14:56:33 lulin Exp $ }
...
// - new behavior: объединение операций теперь делается в Tl3OperationContainer._Add, а не в Put.
//
...
function TevOptimizedContext.JoinWith(P : k2OpRefList._l3TypedListPrim_): Long;
 ...
 function _AddClear(P: PIk2Tag; Index: Long): Bool;
 begin
...
var
 ...
 function _Clear(P: PIk2Tag; Index: Long): Bool;
 begin
  O.Para := P^;
  O.Undo(nil);
  Result := true;
