...
{ $Id: evRuler.pas,v 1.81 2012/08/10 18:19:08 lulin Exp $ }
...
procedure TevCustomRuler.Scroll(iD: TevInch);
  {-}
var
 l_CR : Tl3SRect;
 l_S  : Bool;
...
procedure TevCustomRuler.pm_SetOnSetMarker(const aValue: TevOnSetMarker);
  {-}
begin
 OnSetMarker := aValue;
end;
