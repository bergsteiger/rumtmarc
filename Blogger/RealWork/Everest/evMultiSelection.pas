...
//#UC START# *48E252D40298_48E3B50501DB_impl*
 ...
 begin
  if (f_Selected <> nil) AND not f_Selected.Empty then
   Result := TevMultiSelectionBlock.Make(aDocument, f_Selected)
  else
   Result := inherited DoGetBlock(aDocument);
...
//#UC START# *48E274CF007B_48E3B50501DB_impl*
 if AllowAddToMulty AND AllowMultiSelect then
 begin
...
procedure TevMultiSelection.DoSetDocument(const OldDocument: InevTag;
  const Value: InevTag);
