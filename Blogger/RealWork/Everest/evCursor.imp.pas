...
{$Define evCursor_imp}
 ...
 // property methods
   ...
   function pm_GetListner: InevPointListner; virtual;
 protected
 // realized methods
 ...
 // protected methods
   ...
   procedure DoDisableListner; virtual;
   procedure DoEnableListner; virtual;
...
function _evCursor_.pm_GetListner: InevPointListner;
...
//#UC START# *49E317B802F3_49DE2726027E_impl*
 if aValue then
  _Instance_R_(Self).Move(aView, ev_ocBottomRight);
...
//#UC START# *49E358670168_49DE2726027E_impl*
 ...
 if not aPoint.Obj.IsSame(ParaX) then
  Result := 1
 else
...
procedure _evCursor_.DoDisableListner;
...
end;//_evCursor_.DoDisableListner

procedure _evCursor_.DoEnableListner;
...
end;//_evCursor_.DoEnableListner
...
//#UC START# *47C68A0E01E9_49DE2726027E_impl*
 ...
 if (l_Listner <> nil) then
  l_Listner.CursorChanged(_Instance_R_(Self));
...
procedure _evCursor_.DisableListner;
...
end;//_evCursor_.DisableListner

procedure _evCursor_.EnableListner;
...
end;//_evCursor_.EnableListner

procedure _evCursor_.Assign(Source: TPersistent);
//#UC START# *478CF34E02CE_49DE2726027E_var*
//#UC END# *478CF34E02CE_49DE2726027E_var*
begin
//#UC START# *478CF34E02CE_49DE2726027E_impl*
 if (Self = Source) then
  Exit
 else
 if (Source Is _evCursor_) then
  ...
  inherited;
//#UC END# *478CF34E02CE_49DE2726027E_impl*
...
procedure _evCursor_.ForceStore;
//#UC START# *49DF6967030D_49DE2726027E_var*
var
 l_I : InevBasePoint;
//#UC END# *49DF6967030D_49DE2726027E_var*
begin
//#UC START# *49DF6967030D_49DE2726027E_impl*
 l_I := Self.GetInner;
 if (l_I <> nil) then
  l_I.ForceStore;
 inherited;
//#UC END# *49DF6967030D_49DE2726027E_impl*
end;//_evCursor_.ForceStore
