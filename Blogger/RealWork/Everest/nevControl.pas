...
type
 _evStyleTableListner_Parent_ = TafwControl;
 {$Include ..\Everest\evStyleTableListner.imp.pas}
 TnevControl = class(_evStyleTableListner_, InevViewMetrics, InevControl)
 private
 // private fields
   f_WebStyle : Boolean;
...
//#UC START# *48E1F7A9003B_48E0E5C1032A_impl*
 ...
 Result := Result.Sub(Il3Canvas(Canvas).InitialDCOffset);
...
function TnevControl.IsTagCollapsed(const aTag: InevTag): Boolean;
