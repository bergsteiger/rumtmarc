...
{ $Id: eeVirtualNode.pas,v 1.2 2012/11/01 07:10:30 lulin Exp $ }
   ...
   {* Базовая реализация виртуального узла дерева. }
    ...
    // interface methods
      ...
      procedure IeeNode_Set_ID(aValue: Integer);
        {-}
      function  IeeNode_Get_HasChild: Windows.Bool;
        {-}
      ...
      function  IeeNode_IsSameNode(const aNode: IeeNode): Windows.Bool;
        {-}
...
function TeeVirtualNode.IeeNode_Get_HasChild: Windows.Bool;
  {-}
begin
 Result := HasChild;
end;
...
function TeeVirtualNode.Get_IsFirst: Windows.Bool;
  {-}
begin
 Result := IsFirst;
end;

function TeeVirtualNode.Get_IsLast: Windows.Bool;
  {-}
begin
 Result := IsLast;
end;
...
function TeeVirtualNode.IeeNode_IsSameNode(const aNode: IeeNode): Windows.Bool;
  {-}
var
 l_Node : Il3Node;
begin
