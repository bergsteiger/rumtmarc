...
// Модуль: "w:/common/components/rtl/Garant/EditorUsers/MouseClickOnPoint.imp.pas"
// Родные Delphi интерфейсы (.pas)
// Generated from UML model, root element: <<Impurity::Class>> Shared Delphi Common For Scripts And Tests::EditorUsers::MixIns::MouseClickOnPoint
//
