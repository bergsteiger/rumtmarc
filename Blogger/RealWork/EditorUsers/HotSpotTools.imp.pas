...
// Модуль: "w:/common/components/rtl/Garant/EditorUsers/HotSpotTools.imp.pas"
// Родные Delphi интерфейсы (.pas)
// Generated from UML model, root element: <<Impurity::Class>> Shared Delphi Common For Scripts And Tests::EditorUsers::MixIns::HotSpotTools
//
// Работа с хотспотом
//
//
...
//#UC START# *4D53D37F00AE_4D53D342026E_impl*
 ...
 l_State.rKeys := [];
 if aText.Document.QT(InevHotSpotTester2, l_HotSpotTester, aText.TextSource.Processor) then
