...
{ $Id: m3Index.pas,v 1.5 2013/04/12 16:25:08 lulin Exp $ }
...
type
  Tm3ParaIndexBuilderTools = class(Tl3Base,
...
begin
 ...
 {$Else  m3UseMorph}
 Normalizater := Tm3Normalizater.MakeInterface;
 {$EndIf m3UseMorph}
end;
...
begin
 ...
 if (Result = nil) then begin
  if aReadOnly then
   Result := Tm3ReadModeStorageManager.MakeInterface(f_IndexStorageName)
  else
