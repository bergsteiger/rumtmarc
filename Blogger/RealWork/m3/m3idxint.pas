...
//
*)
// $Id: m3idxint.pas,v 1.3 2011/12/28 09:29:10 lulin Exp $
...
uses
 ...
 type
        ...
        Im3IndexStorageManager=   interface;
        ...
        Im3IndexComparer=         interface(IUnknown) ['{9820EEC9-CD10-443B-99FF-815E0A06C9F0}']
         {* Интерфейс для сравнивания двух адресов. }
        ...
        Im3IndexUpdater=          interface(IUnknown) ['{7FD96322-8B38-471B-97A3-E276C3737E6F}']
         {* Построитель индекса. }
                ...
                function          GetDatePrefix       (
                  ...
                  {* - возвращает префикс для дат. }

                function          GetNumbPrefix       (
                                                      ): WideString;
                  {* - возвращает префикс для чисел. }

                function          GetTextPrefix       (
                                                      ): WideString;
                  {* - возвращает префикс для текста. }
                ...
                procedure         AddStopValue        (const ANormalizater: Im3Normalizater;
                  ...
                  {* - добавляет значение в стоп-лист. }
        ...
        Im3IndexSearcher = interface(IUnknown)
         ...
         ['{8415E223-14A7-499E-AC89-0F91B7D8E39F}']
          // public methods
            function GetDatePrefix: WideString;
              {* - возвращает префикс для дат. }
            function GetNumbPrefix: WideString;
              {* - возвращает префикс для чисел. }
            function GetTextPrefix: WideString;
              {* - возвращает префикс для текста. }
  ...
  Im3IndexStorageManager = interface(IUnknown)
   {* Менеджер хранилища для индекса. }
