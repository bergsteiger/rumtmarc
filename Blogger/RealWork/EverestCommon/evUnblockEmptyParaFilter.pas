...
//#UC START# *4836D4C20059_4C56D4E002D2_impl*
 if CurrentType.InheritsFrom(k2_idLeafPara) and (SkipLevel = 3) then
 begin
  ...
  begin
   ...
   begin
    ...
    Generator.StartChild(l_Para.TagType.ID);
    try
     l_Para.Write(Generator);
    finally
     Generator.Finish;
    end;
    // удаляем параграф
...
//#UC START# *4C56D54B002A_4C56D4E002D2_impl*
 Result := (aID < 0) and (aID = -k2_idBlock);//TypeTable.TypeByHandle[-aID].InheritsFrom(k2_idBlock);
