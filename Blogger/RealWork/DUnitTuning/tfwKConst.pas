...
// Generated from UML model, root element: <<Interfaces::Category>> Shared Delphi TFW::DUnitTuning::tfwKConst
//
...
{$If defined(nsTest) AND not defined(Archi) AND not defined(Nemesis) AND not defined(NotTunedDUnit)}
const
  { Other }
 KUser = '';
 KUserPassword = '';
{$IfEnd} //nsTest AND not Archi AND not Nemesis AND not NotTunedDUnit
