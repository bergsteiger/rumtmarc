...
// Generated from UML model, root element: <<Interfaces::Category>> Shared Delphi TFW::MTDOrb::pi_int
//
//
...
type
 IORBInitInfo = interface(IUnknown)
   ['{120E9EB2-D621-4816-8998-92450A60DCC6}']
 end;//IORBInitInfo

 IClientRequestInfo = interface(IUnknown)
