...
{ $Id: m4DocumentAddress.pas,v 1.21 2012/11/01 09:43:34 lulin Exp $ }
...
type
  ...
  Tm4Address = class(Tl3CacheableBase, Im4Address)
   {* Адрес слова. }
    private
    // internal fields
...
function Tm4Address.OCompare(anObject: TObject): Long;
  //override;
  {-}
begin
