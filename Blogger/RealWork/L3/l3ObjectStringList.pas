...
{ Начат: 03.12.2003                                                        }
{ $Id: l3ObjectStringList.pas,v 1.14 2008/03/20 09:48:40 lulin Exp $}
...
// - add: добавлен метод Insert в Tl3ObjectStringList
//
   ...
   private
    ...
    // internal methods
      function  StringItemClass: Rl3String;
        ...
        {-}
   public
    function Add(const aSt: String; const anObj: Tl3Base): Long; overload;
     {* - добавляет в список строчку с объектом.}

    procedure Insert(Index: Long; const aSt: String; const anObj: Tl3Base); overload;
...
procedure Tl3ObjectStringList.Insert(Index: Long; const aSt: String; const anObj: Tl3Base);
var
 l_St : Tl3ObjRefString;
begin
 l_St := Tl3ObjRefString.Make(l3PCharLen(aSt), anObj);
