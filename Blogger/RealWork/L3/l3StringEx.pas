...
{ $Id: l3StringEx.pas,v 1.54 2013/07/08 16:43:15 lulin Exp $ }
...
begin
 Result := aOutLen;
 Case aCodePage of
  CP_Tatar : l3TatarToUnicode(aIn, aOut, aInLen);
  CP_TatarOEM : l3TatarOEMToUnicode(aIn, aOut, aInLen);
  else
...
begin
 Result := aOutLen;
 Case aCodePage of
  CP_Tatar : l3UnicodeToTatar(aIn, aOut, aInLen);
  CP_TatarOEM : l3UnicodeToTatarOEM(aIn, aOut, aInLen);
  else
