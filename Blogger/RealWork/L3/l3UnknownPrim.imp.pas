...
{ $Id: l3UnknownPrim.imp.pas,v 1.31 2013/08/22 15:35:13 lulin Exp $ }
...
begin
 ...
 begin
  {$IfDef _UnknownNeedL3}
  if (l3InterlockedDecrement(f_RefCount) = 0) then
  {$Else  _UnknownNeedL3}
  ...
  end;//l3InterlockedDecrement(f_RefCount) = 0
 end;//BeforeFree
end;
...
begin
 ...
 begin
  ...
  begin
   l_Fake := Self;
   l_MM := l3System.GetMM(InstanceSize);
   if (l_MM <> nil) then
    l_MM.FreeMem(l_Fake);
