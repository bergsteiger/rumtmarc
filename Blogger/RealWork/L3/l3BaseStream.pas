...
{ $Id: l3BaseStream.pas,v 1.37 2012/03/05 16:42:31 lulin Exp $ }
   ...
   {* Базовый класс потоков, поддерживающих счетчик ссылок и интерфейсы IUnknown и IStream. }
    ...
    {interface methods}
      ...
      function IStreamSeek(dlibMove: Large; dwOrigin: Longint;
        out libNewPosition: Large): HResult; stdcall;
      function IStreamSetSize(libNewSize: Large): HResult; stdcall;
      function IStreamCopyTo(stm: IStream; cb: Large; out cbRead: Large;
        out cbWritten: Large): HResult; stdcall;
      function IStreamCommit(grfCommitFlags: Longint): HResult; stdcall;
      function IStreamRevert: HResult; stdcall;
      ...
      function IStreamClone(out stm: IStream): HResult; stdcall;
