...
{ $Id: l3KeyWrd.pas,v 1.24 2013/04/04 11:33:02 lulin Exp $ }
...
type
  ...
  Tl3KeyWords = class(Tl3Dictionary, Il3KeywordFinder)
   ...
   function Get_KeywordByName(const aName: AnsiString): Tl3PrimString;
      function pm_GetKeyWordByID(anID: Long): Tl3KeyWord;
        {-}
      function pm_GetStringByID(anID: Long): AnsiString;
        {-}
    public
    {public methods}
    ...
    public
    // public properties
      property KeyWordByID[anID: Long]: Tl3KeyWord
        read pm_GetKeyWordByID;
        {-}    
      property StringByID[anID: Long]: AnsiString
        read pm_GetStringByID;
        {-}    
  end;{Tl3KeyWords}
...
function Tl3KeyWords.Get_ParentFinder: Il3KeywordFinder;
begin
 Result := nil;
end;

function Tl3KeyWords.Get_KeywordByName(const aName: AnsiString): Tl3PrimString;
begin
 Result := DRbyName[aName];
end;

function Tl3KeyWords.pm_GetKeyWordByID(anID: Long): Tl3KeyWord;
  {-}
begin
 Result := DRByID[anID] As Tl3KeyWord;
end;

function Tl3KeyWords.pm_GetStringByID(anID: Long): AnsiString;
  {-}
var
 l_DR : Tl3KeyWord;
begin
 l_DR := KeyWordByID[anID];
 if (l_DR = nil) then
  Result := ''
 else
  Result := l_DR.AsString;
end;
