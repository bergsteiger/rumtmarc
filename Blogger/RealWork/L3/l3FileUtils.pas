...
// Уточнение функции GetUniqFileName (376439705)
//
...
// исправлена CopyFile - добавлена обработка ошибки
//
...
// - bug fix: процедура CopyFile - ошибка копирования не прерывала выполение, что приводило к удалению исходного файла без создания конечного
//
...
// - new behavior: CopyFile - открытие исходного файла в режиме fmShareDenyWrite
//
...
// - change proc: CopyFile - сделан параметр по умолчанию.
//
...
uses
 ...
 Const
  ...
  procedure ProcessDirectory(const aDir: TFileName;
                             ...
                             aData: Pointer = nil);
    {* - Переюиоаеь все поддиректории в директории aDir. }                         
