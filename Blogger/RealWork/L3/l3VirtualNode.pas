...
{ $Id: l3VirtualNode.pas,v 1.15 2012/08/02 09:30:38 kostitsin Exp $ }
  ...
  Tl3CustomVirtualNode = class(_l3LockedChange_, Il3Node, Il3NodeWrap, Il3RootNode, Il3InternalNode)
    ...
    // public methods
      procedure ReleaseChilds;
        override;
        {-}
      procedure Notify(aOperation : Integer; const aNode : Il3Node);
        override;
        {-}
...
procedure Tl3CustomVirtualNode.Notify(aOperation : Integer; const aNode : Il3Node);
begin
 inherited Notify(aOperation, aNode);
 CallNodeNotify(aOperation, aNode);
end;

function Tl3CustomVirtualNode.GetNumInParent(aOnlyOneLevel : Boolean = false) : Integer;
var
 l_Prev : Il3Node;
begin
 Result := 0;
...
function Tl3CustomVirtualNode.IsAcceptChild(const aChild : Il3Node) : Boolean;
begin
 Result := (aChild as Il3NodeWrap).GetSelf.InheritsFrom(ChildNodeClass);
end;

function Tl3CustomVirtualNode.InsertChildBefore(const aNextChild : Il3Node;
                                                const aChild     : Il3Node) : Il3Node;
var
...
function Tl3CustomVirtualNode.Move(aDirection : Tl3Direction) : Boolean;
var
...
function  Tl3CustomVirtualNode.GetChildByNumber(aNum : Integer) : Il3Node;
begin
 Result := ChildNode;
 while (Result <> nil) do
 begin
...
function Tl3CustomVirtualNode.Iterate(Action          : Tl3NodeAction;
                                      IterMode        : integer = 0;
                                      const aFromNode : Il3Node = nil) : Il3Node;
var
 lCurNode       : Il3Node;
...
function Tl3VirtualFlagsNode.Get_Flags: Integer;
  //override;
  {-}
begin
 Result := f_Flags;
...
procedure Tl3VirtualFlagsNode.Set_Flags(aValue : Integer);
  //override;
  {-}
begin
 f_Flags := aValue;
