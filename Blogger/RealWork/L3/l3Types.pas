...
{ $Id: l3Types.pas,v 1.133 2013/04/04 11:33:02 lulin Exp $ }
...
// - класс Tl3InterfacedComponent сделан кешируемым.
//
...
type
  ...
  Tl3IteratorAction = function(Data: Pointer; Index: Long): Bool; register;
...
type
  ...
  Tl3Duplicates = (l3_dupIgnore, l3_dupAccept, l3_dupError, l3_dupAssign, l3_dupChange, l3_dupUseOld);
