...
type
 ...
 Tl3CResString = class(Tl3CacheableBase, Il3CString)
 protected
 // realized methods
   function pm_GetAsWStr: Tl3WString;
 end;//Tl3CResString

 Tl3CNodeString = class(Tl3CacheableBase, Il3CString)
 protected
 // realized methods
   function pm_GetAsWStr: Tl3WString;
 end;//Tl3CNodeString

 Tl3CWideString = class(Tl3CacheableBase, Il3CString)
 protected
 // realized methods
   function pm_GetAsWStr: Tl3WString;
 end;//Tl3CWideString

 Tl3CConstDelphiString = class(Tl3CacheableBase, Il3CString)
 protected
 // realized methods
   function pm_GetAsWStr: Tl3WString;
 end;//Tl3CConstDelphiString

 Tl3CDelphiString = class(Tl3CacheableBase, Il3CString)
 protected
 // realized methods
   function pm_GetAsWStr: Tl3WString;
 end;//Tl3CDelphiString

 Tl3SystemPrim = {abstract} class(Tl3CBase)
