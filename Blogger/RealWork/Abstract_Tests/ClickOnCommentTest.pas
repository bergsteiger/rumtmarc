...
type
 ...
 {$Include w:\common\components\rtl\Garant\EditorUsers\ClickOnCommentHeader.imp.pas}
 ...
 // realized methods
   ...
   {$IfEnd} //nsTest AND not NoVCM
   function CheckCollapsed(const aText: TevCustomEditorWindow): Boolean; override;
 protected
...
function TClickOnCommentTest.CheckCollapsed(const aText: TevCustomEditorWindow): Boolean;
