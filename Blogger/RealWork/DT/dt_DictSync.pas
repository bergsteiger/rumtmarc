...
type
 ...
 private
  ...
  procedure pm_SetDictID(const aValue: TDLType);
 protected
 ...
 public
  function Execute(aDictID: TDLtype; aDictFolder: String; aCorrectLinks: Boolean): Boolean;
...
Uses
 dt_DictExport, dt_DictImport, dt_Dict, dt_Serv, dt_Const, dt_Link, dt_LinkServ,
 l3FileUtils, l3ShellUtils,
 SysUtils, Controls, Dialogs,
 ddHTInit, ddUtils, ddProcessDlg;
...
begin
 Result:= False;
 l_DestFolder:= ConcatDirName(g_BaseEngine.PathRec.DocsPath, 'garant');
...
begin
 ...
 l_CurrentFileName:= ConcatDirName(ConcatDirName(g_BaseEngine.PathRec.DocsPath, 'garant'), l_DictFileName);
...
function TdtDictSync.Execute(aDictID: TDLtype; aDictFolder: String; aCorrectLinks: Boolean): Boolean;
var
...
procedure TdtDictSync.pm_SetDictID(const aValue: TDLType);
begin
