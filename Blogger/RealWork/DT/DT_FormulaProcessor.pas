...
{ $Id: DT_FormulaProcessor.pas,v 1.2 2010/09/28 13:06:08 fireton Exp $ }
...
var
 ...
 begin
  ...
  LinkServer.Family:=fFamily;
  SrchTblH:=DictServer.GroupTbl[dlDateNums].TblH;
  DictServer.GroupTbl[dlDateNums].RefreshSrchList;
  SrchList:=@DictServer.GroupTbl[dlDateNums].fSrchList;
  ...
  htClearResults(Res1List);
  LinkServer[dlDateNums].SrchOnBodies(Res2List,Res1List,Nil,True);
 ...
 begin
  ...
  try
   ...
   if TmpLen<DictServer.GroupTbl[dlDateNums].fldLength[dnNumFld]
    then
     begin
