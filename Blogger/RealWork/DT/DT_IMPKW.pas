...
{ $Id: DT_IMPKW.pas,v 1.52 2013/01/17 10:11:56 voba Exp $ }
...
Type
 TDictLinkImportServer = class(Tl3Base)
  ...
  public
   constructor Create(aFamily: TFamilyID; aDictId: TDLType; aClearDictionary, aNeedAddToDictionary: Boolean); reintroduce;
...
constructor TDictLinkImportServer.Create(aFamily: TFamilyID; aDictId: TDLType; aClearDictionary, aNeedAddToDictionary:
    Boolean);
Begin
