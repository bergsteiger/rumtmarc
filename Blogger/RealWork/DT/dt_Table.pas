...
{ $Id: dt_Table.pas,v 1.47 2013/04/19 13:07:39 lulin Exp $ }
...
type
 TdtTable = class(TdtTblInfo, IEditTbl)
  ...
  public
   ...
   procedure GetFieldFromRecord(aRecord : PAnsiChar; aField : Word; var aBody); virtual; //overload;
   //procedure GetFieldFromRecord(const aRecHandle : RHandle; aField : Word; var aBody); overload;

   procedure PutFieldToRecord(aRecord : PAnsiChar; aField : Word; const aBody); virtual;
...
*)
procedure TdtTable.GetFieldFromRecord(aRecord : PAnsiChar; aField : Word; var aBody);
Var
 TmpSize,
 I        : Word;
begin
...
procedure TdtTable.PutFieldToRecord(aRecord : PAnsiChar; aField : Word; const aBody);
var
 lByte : Byte;
 lStrLen : Integer;
begin
...
var
 ...
 begin
  Result := True;
  l_Filer.Writeln(GenRecStr(aItemPtr));
 end;
...
begin
 ...
 try
  ...
  try
   lRecs.IterateRecords(lRAProcStub, []);
  finally
   FreeAndNil(l_Filer);
  end;
 finally
