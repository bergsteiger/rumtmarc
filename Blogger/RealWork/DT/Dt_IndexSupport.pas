...
{ $Id: Dt_IndexSupport.pas,v 1.11 2011/06/10 12:49:03 voba Exp $ }
...
implementation
 uses SysUtils,
      ...
      Dt_Serv, DT_Sab, DT_Doc, dt_Const, DT_Query;
...
begin
 ...
 DeleteFile(lIdxFileName);
 If not fileExists(lIdxFileName) then
 begin
  l_ParaIndexBuilder := Tm3ParaIndexBuilder.Create(Tm3FullModeStorageManager.MakeInterface(lIdxFileName));
  try
