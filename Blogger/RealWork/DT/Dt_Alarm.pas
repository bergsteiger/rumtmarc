...
{ $Id: Dt_Alarm.pas,v 1.28 2012/02/01 12:00:49 voba Exp $ }
...
begin
 ...
 begin
  RefreshSrchList;
  htSearch(@fSrchList, tmpSab, Handle, alDocID, Equal, @aDocID, nil);
 end;
...
begin
 ...
 begin
  ...
  htSearch(@fSrchList,Result,Handle,alDocID,Equal,@aDocID,nil);
 end;
end;
