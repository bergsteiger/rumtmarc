...
{ $Id: Dt_Active.pas,v 1.41 2011/07/28 08:41:48 voba Exp $ }
...
begin
 ...
 begin
  RefreshSrchList;
  htSearch(@fSrchList,tmpSab,Handle,actDocID,Equal,@aDocID,nil);
 end;
...
begin
 ...
 begin
  ...
  htSearch(@fSrchList,Result,Handle,actDocID,Equal,@aDocID,nil);
 end;
end;
