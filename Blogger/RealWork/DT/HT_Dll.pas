...
// $Id: HT_Dll.pas,v 1.19 2013/07/08 09:29:45 voba Exp $
...
(* Закрыть доступ к результатам поиска в БДС *)
  Procedure htCloseResults( Var fpSrc: SAB );stdcall;
...
(* Возвращает одну из констант RES_????? *)
  Function htResultsType( Var fpSrc: SAB ):SmallInt;stdcall;
