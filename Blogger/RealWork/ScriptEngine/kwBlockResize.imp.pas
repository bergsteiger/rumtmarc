...
//#UC START# *50B8BCDF0093_514BFB250118_impl*
 ...
 while not l_Cursor.InheritsFrom(k2_idBlock) do
 begin
  l_Map := l_Map.Outer as InevMap;
  l_Cursor := l_Cursor.ParentPoint;
 end; // while not l_Cursor.InheritsFrom(k2_idBlock) do
 ...
 l_State.rKeys := [];
 if anEditor.Document.QT(InevHotSpotTester2, l_HotSpotTester, anEditor.TextSource.Processor) then
