...
// Generated from UML model, root element: <<SimpleClass::Class>> Shared Delphi Scripting::ScriptEngine::Scripting::TtfwStoredValues
//
//
...
procedure TtfwStoredValues.Restore;
...
//#UC START# *4F494C0D009A_4F49408A03C0_impl*
 ...
 begin
  l_V := Items[l_Index];
  try
   TkwCompiledVar(l_V.rWord).Value := l_V.rValue;
  finally
   Finalize(l_V);
  end;///try..finally
 end;//for l_Index
