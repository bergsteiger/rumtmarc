...
// Generated from UML model, root element: <<SimpleClass::Class>> Shared Delphi Scripting::ScriptEngine::Scripting::TkwCompiledCase
//
//
...
{$If not defined(NoScripts)}
type
 TkwCompiledCase = class(TkwCompiledWord)
 protected
