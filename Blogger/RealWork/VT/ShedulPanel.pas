...
{ Модуль: ShedulPanel                  }
{ Начат: 03.12.2003                    }
{ $Id: ShedulPanel.pas,v 1.40 2008/02/27 15:50:48 narry Exp $ }
...
procedure TDateTypeObj.Assign(P: TPersistent);
begin
...
function TDateTypeObj.OCompare(anObject: TObject): Integer;
  //override;
  {-}
begin
