...
{ $Id: vtPreviewPanel.pas,v 1.37 2013/03/29 11:36:59 lulin Exp $ }
...
// - new behavior: панель _Preview регистрирует себя в качестве IafwSettingsListner.
//
...
procedure TvtCustomPreviewPanel.Print;
  {-}
begin
 if (Preview <> nil) then
  Preview.Print;
