...
//#UC START# *4FC7711F014B_4D90583503C2_impl*
 ...
 case a_TailPosition of
  ...
  vtTailRight:
   begin
    Inc(a_WidthOut, Round(a_FontSize * (cTailMul + cBtnWidthMul + cIndentHMul * 2 + cBtnIndentMul)));
    Inc(a_HeightOut, Round(a_FontSize * (cIndentTopMul + cIndentBottomMul)));
   end;
  vtTailTop,
  vtTailBottom:
   begin
    Inc(a_WidthOut, Round(a_FontSize * (cBtnWidthMul + cIndentHMul * 2 + cBtnIndentMul)));
