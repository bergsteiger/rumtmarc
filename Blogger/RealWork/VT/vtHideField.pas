...
type
 ...
 // private methods
   ...
   function GetHeaderRect: TRect;
     {* полная высота заголовка до клиентского компонента }
...
function TvtCustomHideField.GetHeaderRect: TRect;
//#UC START# *5110EA78021E_4E732D8B0291_var*
var
 l_I                 : Integer;
 l_BeforeClientSpace : Integer;
//#UC END# *5110EA78021E_4E732D8B0291_var*
begin
//#UC START# *5110EA78021E_4E732D8B0291_impl*
 SetRectEmpty(Result);
 Result := ClientRect;
 l_I := 0;
 ...
 Result.Bottom := Max(Result.Top + l_I, GetHeaderLineRect.Bottom) + l_BeforeClientSpace;
//#UC END# *5110EA78021E_4E732D8B0291_impl*
end;//TvtCustomHideField.GetHeaderRect

function TvtCustomHideField.GetCaptionRect: TRect;
//#UC START# *5110EAB300C3_4E732D8B0291_var*
var
 l_I  : Integer;
 l_R  : TRect;
 l_IC : Il3InfoCanvas;
//#UC END# *5110EAB300C3_4E732D8B0291_var*
begin
//#UC START# *5110EAB300C3_4E732D8B0291_impl*
...
//#UC END# *5110EAB300C3_4E732D8B0291_impl*
end;//TvtCustomHideField.GetCaptionRect
...
//#UC START# *51124356016F_4E732D8B0291_impl*
 with TevStyleInterface.Make(k2_idTextPara, f_StyleId) do
 try
...
//#UC START# *48E22B250241_4E732D8B0291_impl*
 ...
 if (hfoHyperlink in f_Options) and (not l3IsNil(CCaption)) and
   (PtInRect(GetCaptionRect, Point(X, Y)) or
...
var
 ...
 begin
  Result := (hfoHyperlink in f_Options) and
            (PtInRect(GetCaptionRect, l_Point) or
 ...
 begin
  Result := // включено скрытие
            ...
            // мыш между нажитием и отпусканием не двигали
