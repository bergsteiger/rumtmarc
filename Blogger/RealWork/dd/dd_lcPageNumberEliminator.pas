...
type
 ...
 private
  ...
  function IsTextPara(aTag: Ik2Tag): Boolean;
  function ParaWithText(aTag: Ik2Tag): Boolean;
...
procedure Tdd_lcPageNumberEliminator.DoFlushBuffer(const aLeaf: Ik2Tag; aTagId: Integer; aNeedCloseBracket : Boolean);
var
 i, j: Integer;
 l_T, l_loCase: Ik2Tag;
...
function Tdd_lcPageNumberEliminator.IsTextPara(aTag: Ik2Tag): Boolean;
begin
 Result := (aTag.IsValid) and aTag.InheritsFrom(k2_idTextPara);
end;
...
function Tdd_lcPageNumberEliminator.ParaWithText(aTag: Ik2Tag): Boolean;
begin
