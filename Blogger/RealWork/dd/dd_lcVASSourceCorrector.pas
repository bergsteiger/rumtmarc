...
{ $Id: dd_lcVASSourceCorrector.pas,v 1.2 2011/03/29 07:41:06 narry Exp $ }
...
procedure Tdd_lcVASSourceCorrector.BeforeFlushHeader(aHeaderRoot: Ik2Tag);
var
 l_Sources, l_Types: Ik2Tag;
 i: Integer;
