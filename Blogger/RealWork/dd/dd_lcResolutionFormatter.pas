...
{ $Id: dd_lcResolutionFormatter.pas,v 1.27 2013/04/12 15:02:04 lulin Exp $ }
...
type
 ...
 private
  ...
  function CheckCourtName(const aPara: Ik2Tag): Tdd_lcTextReaction;
  function CheckPostanovlenie(const aPara: Ik2Tag; aWithResolution: Boolean; out
      thePostanovlenieFound: Boolean): Tdd_lcTextReaction;
  function CheckResolution(const aPara: Ik2Tag): Tdd_lcTextReaction;
  procedure ConvertBrackedText;
  procedure DoHeaderFound;
  function FindPostanovlenie(const aPara: Ik2Tag; aWithResolution: Boolean): Boolean;
...
function Tdd_lcResolutionFormatter.CheckCourtName(const aPara: Ik2Tag):
    Tdd_lcTextReaction;
begin
 Result:= lcWrite;
...
function Tdd_lcResolutionFormatter.CheckPostanovlenie(const aPara: Ik2Tag;
...
function Tdd_lcResolutionFormatter.CheckResolution(const aPara: Ik2Tag):
    Tdd_lcTextReaction;
var
 l_S: AnsiString;
...
function Tdd_lcResolutionFormatter.EnableWrite(const aPara: Ik2Tag):
    Tdd_lcTextReaction;
var
...
function Tdd_lcResolutionFormatter.FindPostanovlenie(const aPara: Ik2Tag; aWithResolution: Boolean):
    Boolean;
var
 l_DatePos,
