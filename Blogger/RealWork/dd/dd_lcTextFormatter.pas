...
{ $Id: dd_lcTextFormatter.pas,v 1.39 2013/04/05 12:04:30 lulin Exp $ }
...
type
 ...
 private
  ...
  procedure AddTitle;
  function CheckAddJudge(aPara: Ik2Tag): Boolean;
  function CheckDocStart(aPara: Ik2Tag): Boolean;
  function CheckAddMainJudge(aPara: Ik2Tag): Boolean;
  function CheckNumber(aPara: Ik2Tag): Boolean;
  function CheckConditions(const aLeaf: Ik2Tag): Boolean;
  function CheckDate(aPara: Ik2Tag): Boolean;
  function CheckMainJudge(aPara: Ik2Tag): Boolean;
  function CheckJudge(aPara: Ik2Tag): Boolean;
  function CheckResolution(aPara: Ik2Tag): Boolean;
  procedure ClearParameters;
  function CheckEmptyPara(aPara: Ik2Tag): Boolean;
  function CheckCourtName(aPara: Ik2Tag): Boolean;
  procedure CheckLostParameters;
  function CheckAddNumber(aPara: Ik2Tag): Boolean;
  function CheckPostanovlenie(aPara: Ik2Tag): Boolean;
  function CheckOrder(aPara: Ik2Tag): Boolean;
  function CheckDefinition(aPara: Ik2Tag): Boolean;
  function CheckDefinitionTitle(aPara: Ik2Tag): Boolean;
  procedure CheckPrezidium(aPara: Ik2Tag);
  function CheckStartText(aPara: Ik2Tag): Boolean;
  function CheckUstanovil(aPara: Ik2Tag): Boolean;
  function CheckTitle(aPara: Ik2Tag): Boolean;
  procedure CheckTitleCondition;
  procedure CorrectNumber(aPara: Ik2Tag);
  ...
  function isCourtName(aPara: Ik2Tag): Boolean;
  function IsPrezidium: Boolean;
  function LastNamePresent(aText: AnsiString): Boolean;
    function NormalizeText(const aLeaf: Ik2Tag): AnsiString;
 protected
...
begin
 ...
 begin
  ...
  try
   Generator.AddIntegerAtom(k2_tiStyle, ev_saTxtHeader1);
   Generator.AddStringAtom(k2_tiText, f_DocName);
  finally
   Generator.Finish;
  end;
 end;
...
function Tdd_lcTextFormatter.CheckAddJudge(aPara: Ik2Tag): Boolean;
var
 l_S: AnsiString;
 l_Pos, i: Integer;
begin
...
function Tdd_lcTextFormatter.CheckDocStart(aPara: Ik2Tag): Boolean;
begin
 Result:= False;
...
function Tdd_lcTextFormatter.CheckAddMainJudge(aPara: Ik2Tag): Boolean;
var
 l_S: AnsiString;
begin
 Result:= True;
...
function Tdd_lcTextFormatter.CheckNumber(aPara: Ik2Tag): Boolean;
var
 l_S: AnsiString;
begin
 Result := True;
...
function Tdd_lcTextFormatter.CheckConditions(const aLeaf: Ik2Tag): Boolean;
var
...
function Tdd_lcTextFormatter.CheckDate(aPara: Ik2Tag): Boolean;
var
...
function Tdd_lcTextFormatter.CheckEmptyPara(aPara: Ik2Tag): Boolean;
begin
...
function Tdd_lcTextFormatter.CheckMainJudge(aPara: Ik2Tag): Boolean;
var
 i, l_Pos: Integer;
 l_S: AnsiString;
begin
...
function Tdd_lcTextFormatter.CheckJudge(aPara: Ik2Tag): Boolean;
var
 i, l_Pos: Integer;
 l_S: AnsiString;
begin
...
function Tdd_lcTextFormatter.CheckResolution(aPara: Ik2Tag): Boolean;
var
 l_S: AnsiString;
 l_Pos: Integer;
begin
...
function Tdd_lcTextFormatter.CheckCourtName(aPara: Ik2Tag): Boolean;
begin
 Result:= True;
 if not (lc_lfTitle in f_Do) then
 begin
...
function Tdd_lcTextFormatter.CheckAddNumber(aPara: Ik2Tag): Boolean;
var
 l_S: AnsiString;
begin
 Result := False;
...
function Tdd_lcTextFormatter.CheckPostanovlenie(aPara: Ik2Tag): Boolean;
begin
...
function Tdd_lcTextFormatter.CheckOrder(aPara: Ik2Tag): Boolean;
var
 l_Text: ShortString;
 l_Pos: Integer;
begin
...
function Tdd_lcTextFormatter.CheckDefinition(aPara: Ik2Tag): Boolean;
var
...
function Tdd_lcTextFormatter.CheckDefinitionTitle(aPara: Ik2Tag): Boolean;
begin
 Result:= False;
...
procedure Tdd_lcTextFormatter.CheckPrezidium(aPara: Ik2Tag);
var
 l_Cat: Integer;
begin
...
function Tdd_lcTextFormatter.CheckStartText(aPara: Ik2Tag): Boolean;
var
 i: Integer;
begin
 Result:= False;
...
function Tdd_lcTextFormatter.CheckUstanovil(aPara: Ik2Tag): Boolean;
var
 l_Ok: Boolean;
 l_Text : AnsiString;
 l_pos: Integer;
...
function Tdd_lcTextFormatter.CheckTitle(aPara: Ik2Tag): Boolean;
var
 i, l_Pos: Integer;
 l_S: AnsiString;
...
procedure Tdd_lcTextFormatter.CorrectNumber(aPara: Ik2Tag);
var
 l_Pos: Integer;
 l_Str: AnsiString;
 l_Update: Boolean;
...
procedure Tdd_lcTextFormatter.CorrectTextAndStyle(aLeaf: Ik2Tag);
var
 l_Str: AnsiString;
begin
...
procedure Tdd_lcTextFormatter.DoWritePara(const aLeaf: Ik2Tag);
var
 l_SavePara: Boolean;
begin
...
procedure Tdd_lcTextFormatter.DoStartChild(TypeID: Long);
begin
 inherited;
 if CurrentType.InheritsFrom(k2_idDocument) then
  ClearParameters
...
function Tdd_lcTextFormatter.isCourtName(aPara: Ik2Tag): Boolean;
var
 l_S: AnsiString;
begin
...
function Tdd_lcTextFormatter.NormalizeText(const aLeaf: Ik2Tag): AnsiString;
var
 i: Integer;
begin
