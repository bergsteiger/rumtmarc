...
{ $Id: dd_lcTitleFormatter.pas,v 1.15 2013/04/12 15:02:04 lulin Exp $ }
...
function Tdd_lcTitleFormatter.CheckNumber(aPara: Ik2Tag): Boolean;
var
 l_S: AnsiString;
begin
 Result := False;
...
function Tdd_lcTitleFormatter.EnableWrite(const aPara: Ik2Tag): Tdd_lcTextReaction;
var
 i, l_Pos: Integer;
