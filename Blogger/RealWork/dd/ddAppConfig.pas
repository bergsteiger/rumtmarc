...
//#UC START# *52149F560306_4B990F100126_impl*
  ...
  for I := 0 to Pred(f_Root.ChildrenCount) do
   CalcNodeBounds(f_Root.Children[I]);
  ...
  Windows.SystemParametersInfo(SPI_GETWORKAREA, 0, @l_WorkAreaRect, 0);
...
//#UC START# *5214AC2000AD_4B990F100126_impl*
 IddConfigNode(f_Root).LoadTree(aStream);
...
//#UC START# *5214AC95018C_4B990F100126_impl*
 IddConfigNode(f_Root).SaveTree(aStream);
