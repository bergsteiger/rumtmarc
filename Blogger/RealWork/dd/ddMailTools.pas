...
function ddPurgeOldMail(const aDir: AnsiString; aKeepDays: Integer = 30): Integer;
    ...
    begin
     ...
     try
      ...
      begin
       ...
       if l_Ok and ((l_Today - l_DT.D) <= aKeepDays) then
       begin
        Inc(l_NewCount);
        ...
        l_NewMailIni.WriteParamStr('File', l_OldMailIni.ReadParamStrDef('File', ''));
...
begin
 ...
 try
  ProcessDirectory(aHomesDir, TFileProcessingFunc(l_Stub), Pointer(aKeepDays));
