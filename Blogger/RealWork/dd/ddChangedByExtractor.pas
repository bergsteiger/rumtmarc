...
{ $Id: ddChangedByExtractor.pas,v 1.11 2013/04/11 16:46:27 lulin Exp $ }
...
type
 ...
 private
  ...
  procedure ReplaceDoubleSoftEnter(const aLeaf: Ik2Tag);
 protected
...
procedure TddChangedByFilter.DoWritePara(const aLeaf: Ik2Tag);
var
...
procedure TddChangedByFilter.ReplaceDoubleSoftEnter(const aLeaf: Ik2Tag);
const
