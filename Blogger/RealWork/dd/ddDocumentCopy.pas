...
{ $Id: ddDocumentCopy.pas,v 1.58 2013/04/11 16:46:27 lulin Exp $ }
...
{ TddDocumentCopier }
constructor TddDocumentCopier.Create(aOwner: TObject = nil);
begin
 inherited;
 f_Family:= 1;
 f_UserID:= GlobalHtServer.CurUserID;
end;
    ...
    try
     ...
     try
      ...
      try
       ...
       try
        l_OutFilter:= TExportFilter.Create(nil, f_Family);
