...
uses k2Reader, {xmlintf,} jclSimpleXML, k2TagGen, ddRTFReader, l3LongintList, Classes, ddLawCaseXMLReader, ddTypes,
 l3base, k2Prim, l3VCLStrings, l3ValLst;

type
 TlcXMLParser = class(Tl3Base)
 private
  f_Date: Integer;
...
constructor TlcKrokXMLParser.Create(anOwner: TObject = nil);
begin
 inherited Create(anOwner);
end;
...
begin
 ...
 try
  ...
  begin
   f_Generator.StartChild(k2_idParticipant);
   try
...
begin
 ...
 begin
  ...
  try
    f_Generator.StartChild(k2_idNumAndDate);
    try
...
constructor TlcXMLParser.Create(anOwner: TObject = nil);
begin
 inherited;
