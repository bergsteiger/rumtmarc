...
//$Id: ddXMLAnnoWriter.pas,v 1.11 2013/04/11 16:46:29 lulin Exp $
...
procedure TddXMLAnnoWriter.StartChild(TypeID: Long);
var
  TT        : Tk2Type;
begin
  inherited;
  TT:= CurrentType;
  if TT.InheritsFrom(k2_idAnnoTopic) then
   f_isDoc := False
  else
...
procedure TddXMLAnnoWriter.WriteTextParagraph(const Para: TddTextParagraph);
var
  i, LinkIndex: LongInt;
