...
{ $Id: dd_lcJudgeFormatter.pas,v 1.30 2013/04/12 15:02:04 lulin Exp $ }
...
type
 ...
 private
  ...
  function CheckAddJudge(const aPara: Ik2Tag): Tdd_lcTextReaction;
  function CheckAddMainJudge(const aPara: Ik2Tag): Tdd_lcTextReaction;
  function CheckJudge(const aPara: Ik2Tag): Tdd_lcTextReaction;
  function CheckMainJudge(const aPara: Ik2Tag): Tdd_lcTextReaction;
  function CheckOrder(const aPara: Ik2Tag): Tdd_lcTextReaction;
 protected
  ...
  function FindLastName(const aPara: Ik2Tag; out theTitle, theLastName: ShortString; out theNotSure:
      Boolean): Boolean;
 public
...
function Tdd_lcJudgeFormatter.CheckAddJudge(const aPara: Ik2Tag): Tdd_lcTextReaction;
var
...
function Tdd_lcJudgeFormatter.CheckAddMainJudge(const aPara: Ik2Tag): Tdd_lcTextReaction;
var
...
function Tdd_lcJudgeFormatter.CheckJudge(const aPara: Ik2Tag): Tdd_lcTextReaction;
var
 l_LastName, l_Title: ShortString;
 l_NotSure: Boolean;
begin
...
function Tdd_lcJudgeFormatter.CheckMainJudge(const aPara: Ik2Tag): Tdd_lcTextReaction;
var
 l_Pos: Integer;
 l_LastName, l_Title: ShortString;
 l_NotSure: Boolean;
...
function Tdd_lcJudgeFormatter.CheckOrder(const aPara: Ik2Tag): Tdd_lcTextReaction;
var
...
function Tdd_lcJudgeFormatter.EnableWrite(const aPara: Ik2Tag): Tdd_lcTextReaction;
begin
...
function Tdd_lcJudgeFormatter.FindLastName(const aPara: Ik2Tag; out theTitle, theLastName: ShortString;
