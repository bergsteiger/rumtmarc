...
{ $Id: ddProgressObj.pas,v 1.60 2013/04/19 13:10:10 lulin Exp $ }
...
type
  ...
  public
   constructor Make(aMaximum: Int64; const aDescription: AnsiString; aSyncWithNext:
       Boolean = True; const aUnitName: ShortString = '');
   procedure Clear;
...
procedure TddProgressObject.Start(aProcessMax: Int64 = 0; const
    aProcessMessage: AnsiString = ''; aSyncWithNext: Boolean = True);
var
...
constructor TddProgressProcess.Make(aMaximum: Int64; const aDescription:
    AnsiString; aSyncWithNext: Boolean = True; const aUnitName: ShortString = '');
begin
 inherited;
 Maximum:= aMaximum;
