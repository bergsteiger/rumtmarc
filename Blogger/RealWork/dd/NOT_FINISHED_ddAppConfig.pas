unit NOT_FINISHED_ddAppConfig;

////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// Библиотека "dd$AppConfig"
// Модуль: "w:/common/components/rtl/Garant/dd/NOT_FINISHED_ddAppConfig.pas"
...
type
 ...
 TddCNodePrim = class(Tl3UsualNode, IddCNode)
 private
 // private fields
...
//#UC START# *5214AC2000AD_4B990F100126_var*
//#UC END# *5214AC2000AD_4B990F100126_var*
begin
//#UC START# *5214AC2000AD_4B990F100126_impl*
 f_Root.LoadTree(aStream);
//#UC END# *5214AC2000AD_4B990F100126_impl*
end;//TddAppConfiguration.LoadStructure
...
//#UC START# *5214AC95018C_4B990F100126_var*
//#UC END# *5214AC95018C_4B990F100126_var*
begin
//#UC START# *5214AC95018C_4B990F100126_impl*
 f_Root.SaveTree(aStream);
//#UC END# *5214AC95018C_4B990F100126_impl*
end;//TddAppConfiguration.SaveStructure
...
//#UC START# *52148E4603B5_4B990F100126get_impl*
 ...
 if f_Items.Count > 0 then
  ...
  raise EddConfigError.Create(rsListEmpty);
...
//#UC START# *52148F90037A_4B990F100126get_var*
//#UC END# *52148F90037A_4B990F100126get_var*
begin
//#UC START# *52148F90037A_4B990F100126get_impl*
 if LastItem is TddButtonConfigItem then
  Result := TddButtonConfigItem(LastItem).Place
 else
  Result := dd_bpAsDefine;
//#UC END# *52148F90037A_4B990F100126get_impl*
end;//TddAppConfiguration.pm_GetButtonPlace

procedure TddAppConfiguration.pm_SetButtonPlace(aValue: TddButtonPlace);
//#UC START# *52148F90037A_4B990F100126set_var*
//#UC END# *52148F90037A_4B990F100126set_var*
begin
//#UC START# *52148F90037A_4B990F100126set_impl*
 if LastItem is TddButtonConfigItem then
  TddButtonConfigItem(LastItem).Place := aValue;
//#UC END# *52148F90037A_4B990F100126set_impl*
...
// start class TddCNodePrim

constructor TddCNodePrim.Create(aNode: TddCustomConfigNode);
//#UC START# *521486E4013C_5215DEF001F9_var*
//#UC END# *521486E4013C_5215DEF001F9_var*
begin
//#UC START# *521486E4013C_5215DEF001F9_impl*
 inherited Create;
 f_Node := aNode;
 Text := l3PCharLen(aNode.Caption);
//#UC END# *521486E4013C_5215DEF001F9_impl*
end;//TddCNodePrim.Create

function TddCNodePrim.Get_Control: TddCustomConfigNode;
