...
{ $Id: dd_lcCityNameFormatter.pas,v 1.7 2013/04/12 15:02:04 lulin Exp $ }
...
type
 ...
 private
  f_CityFound: Boolean;
  function CheckCityName(const aPara: Ik2Tag): Boolean;
 protected
...
function Tdd_lcCityFormatter.CheckCityName(const aPara: Ik2Tag): Boolean;
var
...
function Tdd_lcCityFormatter.EnableWrite(const aPara: Ik2Tag): Tdd_lcTextReaction;
begin
