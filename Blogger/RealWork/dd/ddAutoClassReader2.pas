...
{ $Id: ddAutoClassReader2.pas,v 1.7 2008/07/12 12:35:19 fireton Exp $ }
...
begin
 ...
 LinkServer.Links[dlClasses].StartCaching;
 try
  ...
  begin
   ...
   try
    ...
    begin
     ...
     l_Item:= DictServer.Dict[dlClasses].FindIdByFullPath(l_Text.St);
     ...
     begin
      ...
      begin
       ...
       if l_Doc <> cUndefDocID then
        LinkServer.AddSubNode(dlClasses, l_Doc, l_Sub, l_Item);
       Parser.NextTokenSp;
  ...
  LinkServer.Links[dlClasses].StopCaching;
 end; // try..finally
end;
