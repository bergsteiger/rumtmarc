...
{ $Id: dd_lcYearCodeCorrector.pas,v 1.6 2013/04/11 16:46:29 lulin Exp $ }
...
procedure Tdd_lcYearCodeCorrector.BeforeFlushHeader(aHeaderRoot: Ik2Tag);
var
 l_Sources, l_Numbers: Ik2Tag;
 i, j: Integer;
