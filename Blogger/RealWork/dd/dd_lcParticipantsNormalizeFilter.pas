...
{ $Id: dd_lcParticipantsNormalizeFilter.pas,v 1.4 2013/04/25 10:18:09 fireton Exp $ }
...
function TlclcParticipantsNormalizeFilter.NeedFlushBuffer(const aLeaf: Ik2Tag; aTagId: Integer): Boolean;
begin
 Result := False;
end;
