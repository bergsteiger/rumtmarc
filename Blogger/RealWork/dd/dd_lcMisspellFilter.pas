...
{ $Id: dd_lcMisspellFilter.pas,v 1.8 2013/04/15 05:59:22 narry Exp $ }
...
uses
 l3String, l3Chars, SysUtils, l3BMSearch, TextPara_Const,
...
begin
 if CurrentType.InheritsFrom([k2_idTextPara, k2_idParticipant]) then
 begin
