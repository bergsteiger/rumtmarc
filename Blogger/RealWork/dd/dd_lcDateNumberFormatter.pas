...
{ $Id: dd_lcDateNumberFormatter.pas,v 1.39 2013/04/12 15:02:04 lulin Exp $ }
...
type
 ...
 private
  ...
  function CheckDate(aPara: Ik2Tag): Tdd_lcTextReaction;
  function CheckNumber(aPara: Ik2Tag): Tdd_lcTextReaction;
  procedure CheckParameters;
  function WriteDateNumber(aPara: Ik2Tag): Tdd_lcTextReaction;
 protected
...
function Tdd_lcDateNumberFormatter.CheckDate(aPara: Ik2Tag): Tdd_lcTextReaction;
var
...
function Tdd_lcDateNumberFormatter.CheckNumber(aPara: Ik2Tag):
    Tdd_lcTextReaction;
var
 l_S: AnsiString;
...
function Tdd_lcDateNumberFormatter.WriteDateNumber(aPara: Ik2Tag): Tdd_lcTextReaction;
begin
...
function Tdd_lcDateNumberFormatter.EnableWrite(const aPara: Ik2Tag):
    Tdd_lcTextReaction;
begin
 Result:= lcWrite;
 if not f_DateNumberAdded then
