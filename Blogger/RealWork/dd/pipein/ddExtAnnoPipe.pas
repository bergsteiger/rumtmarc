...
//$Id: ddExtAnnoPipe.pas,v 1.7 2013/04/11 16:46:46 lulin Exp $
 ...
 begin
  ...
  begin
   if IsName(Value.AsString As Tl3CustomString) then
     Generator.AddStringAtom(k2_tiName, Value.AsString)
   else
   begin
    Generator.StartChild(k2_idTextPara);
    try
     Generator.AddIntegerAtom(k2_tiStyle, ev_saNormalAnno);
     Generator.AddStringAtom(k2_tiText, Value.AsString);
    finally
     Generator.Finish;
    end;
   end;
