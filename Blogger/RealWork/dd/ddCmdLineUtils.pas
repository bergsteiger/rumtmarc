...
type
 ...
 public
  ...
  property serverIP: AnsiString read pm_GetserverIP;
...
begin
 ...
 AddString('Server', 'Параметры сервера Архивариуса. Порт по умолчанию 32100', '<serverIP>[:<Port>]', f_ServerParams);
...
function TddBaseCmdLine.pm_GetserverIP: AnsiString;
begin
...
begin
 Result := SplitParam(f_UserParams, 0, 'guest');
end;
