...
{ $Id: ddSearchTree.pas,v 1.3 2012/01/24 10:09:21 fireton Exp $ }
...
type
 ...
 public
  ...
  function Search(const aStr: Tl3WString; out thePos: TddFoundPosRec; out theData: IUnknown): Boolean;
...
function TddSearchTree.Search(const aStr: Tl3WString; out thePos: TddFoundPosRec; out theData: IUnknown): Boolean;
...
var
 ...
 begin
  ...
  while True do
  begin
   if l_SearchAtOneLevel(f_Root, l_Word) then
   begin
    Result := False;
    l_IsFound := True;
