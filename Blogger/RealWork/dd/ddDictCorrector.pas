...
{ $Id: ddDictCorrector.pas,v 1.3 2013/04/11 16:46:27 lulin Exp $ }
...
procedure ddCorrectDictionary(const aDict: TDLType; const aFilenameRus, aFilenameEng: AnsiString);
