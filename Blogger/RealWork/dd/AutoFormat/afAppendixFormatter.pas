...
// $Id: afAppendixFormatter.pas,v 1.2 2013/04/16 09:30:55 fireton Exp $
...
uses StrUtils, TextPara_Const, l3Chars, k2Tags, evdStyles, l3String, ddUtils,
 ...
 SysUtils, l3DateSt, l3LingLib, evdTypes;
...
function TafAppendixFormatter.EnableWrite(const aPara: Ik2Tag): Tdd_lcTextReaction;
var
 i, l_Pos: Integer;
