...
type
 ...
 Tk2OperationContainer = class(Tk2OpRefList, Il3OpPack, Ik2OpPackInternal)
 private
 // private fields
   f_Owner : TObject;
   f_Mode : Pointer;
...
procedure Tk2OperationContainer.MarkModified(const aTarget: IUnknown);
...
function Tk2OperationContainer.GetOwner: TPersistent;
//#UC START# *480DD1890221_47E3C78502FB_var*
//#UC END# *480DD1890221_47E3C78502FB_var*
begin
//#UC START# *480DD1890221_47E3C78502FB_impl*
 Result := TPersistent(f_Owner);
//#UC END# *480DD1890221_47E3C78502FB_impl*
end;//Tk2OperationContainer.GetOwner
