...
{ $Id: k2Tags.pas,v 1.190 2013/06/19 16:51:09 lulin Exp $ }
...
// - new: добавлен тип k2_idBookmark.
//
...
type
  Tk2TagID = (
    ...
    {==================================================================================}
    _k2_tiChildren,         {-список дочерних объектов}        // 166
    _k2_tiFormatted,        {-сформатирован параграф или нет?} // 167
    _k2_tiLimitWidth,       // 168
    _k2_tiDeltaX,           {-смещение по оси X от родителя} // 169
    _k2_tiDeltaY,           {-смещение по оси Y от родителя} // 170
    _k2_tiMap,              {-карта форматирования параграфа} // 171
    _k2_tiMaxHyperlinkHandle, // - максимальный идентификатор гиперссылки // 172
    _k2_tiExcludeSuper,       // - сегменты, которые выкидываем из суперпозиции // 173
    _k2_tiLayerID,            // - идентификатор слоя // 174
    _k2_tiStateCount,         // - количество состояний // 175
    _k2_tiAllChildrenCount, // 176
    _k2_tiRubber,           // 177
    _k2_tiNodeVisibleIndex ,{-видимый индекс в дереве для КЗ - что в корне неправильно,
                             ...
                             еще хуже}// 178
    _k2_tiDefaultText,      // 179
    _k2_tiDefaultNode,      // 180
    _k2_tiModified,         // 181
    _k2_tiOperations        // 182
