...
{ $Id: k2TagTranslator.pas,v 1.13 2009/03/04 18:14:18 lulin Exp $ }
...
procedure Tk2TagTranslator.StartChild(TypeID: Long);
  //override;
  {-}
begin
 inherited;
...
procedure Tk2TagTranslator.AddAtom(AtomIndex: Long; TK: Tk2TypeKind; const Value);
  {override;}
  {-}
begin
 inherited;
