...
{ $Id: k2Reader.pas,v 1.44 2013/04/04 11:21:38 lulin Exp $ }
   ...
   try
    ...
    begin
     if not (E Is El3AbortLoad) AND
        not (E Is EevReadOnly) AND
        not (E Is EevLimitReached) then
     begin
      {$IfDef nsTest}
...
procedure Tk2CustomReader.StartChild(TypeID: Long);
  {-}
begin
 if (f_SkipLevel = 0) then begin
  inherited;
...
procedure Tk2CustomReader.AddAtom(AtomIndex: Long; TK: Tk2TypeKind; const Value);
  {-}
begin
