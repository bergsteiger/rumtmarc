{#(@)$Id: TestFramework.pas,v 1.53 2013/07/11 17:16:16 lulin Exp $ }
...
const
  rcs_id: AnsiString = '#(@)$Id: TestFramework.pas,v 1.53 2013/07/11 17:16:16 lulin Exp $';
  rcs_version : AnsiString = '$Revision: 1.53 $';
 ...
 begin
  ...
  if AnsiStartsStr('TK', Result) then
   ...
   if AnsiStartsStr('K', Result) then
    Delete(Result, 1, 1);
  if AnsiEndsStr('.script', Result) then
  begin
   l_Len := Length('.script');
