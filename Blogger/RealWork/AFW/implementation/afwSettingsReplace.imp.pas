...
//#UC START# *479731C50290_47EA8AEF0077_impl*
 if (afw.Application <> nil) and (afw.Application.Settings <> nil) then
  if (afw.Application.Settings.Notify <> nil) then
   afw.Application.Settings.Notify.RemoveListener(IafwSettingsReplaceListener(Self));
 inherited;
...
//#UC START# *47A042E100E2_47EA8AEF0077_impl*
 ...
 if (afw.Application <> nil) and (afw.Application.Settings <> nil) then
  if (afw.Application.Settings.Notify <> nil) then
   afw.Application.Settings.Notify.AddListener(IafwSettingsReplaceListener(Self));
