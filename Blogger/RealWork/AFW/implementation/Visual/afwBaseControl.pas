...
//#UC END# *48BD1975029Bci*
 ...
 // public methods
   ...
   procedure DoDrawSub(const aSubTarget: IUnknown;
    const Canvas: Il3Canvas;
    const R: Tl3Rect;
    SubType: Tl3Handle;
    const aSub: IUnknown); virtual;
...
procedure TafwBaseControl.DoDrawSub(const aSubTarget: IUnknown;
  const Canvas: Il3Canvas;
  const R: Tl3Rect;
  SubType: Tl3Handle;
  const aSub: IUnknown);
...
//#UC START# *46A453AA0065_48BD1975029B_var*
//#UC END# *46A453AA0065_48BD1975029B_var*
begin
//#UC START# *46A453AA0065_48BD1975029B_impl*
 ...
 Inc(FUpdateCount);
//#UC END# *46A453AA0065_48BD1975029B_impl*
end;//TafwBaseControl.Changing

procedure TafwBaseControl.Changed;
//#UC START# *46A453D1015C_48BD1975029B_var*
//#UC END# *46A453D1015C_48BD1975029B_var*
begin
//#UC START# *46A453D1015C_48BD1975029B_impl*
 Dec(FUpdateCount);
 if (FUpdateCount < 0) then
  FUpdateCount := 0;
 if fStopChangeNotify then
...
//#UC END# *46A453D1015C_48BD1975029B_impl*
...
//#UC START# *47D160620295_48BD1975029B_impl*
 ...
 begin
  l_Res := COMQueryInterface(Tl3GUID(IID), Obj);
  if l_Res.Fail then
