...
type
 TafwSingleCaret = class(Tl3_Base)
  {* Одиночная каретка ввода. }
 private
 // private fields
   f_Owner : TWinControl;
...
constructor TafwSingleCaret.Create(anOwner: TObject = nil);
//#UC START# *47914F960008_480DD00B02E8_var*
//#UC END# *47914F960008_480DD00B02E8_var*
begin
//#UC START# *47914F960008_480DD00B02E8_impl*
 ...
 Reinit;
//#UC END# *47914F960008_480DD00B02E8_impl*
...
procedure TafwSingleCaret.DoSetOwner(Value: TObject);
//#UC START# *4A60A2CF0329_480DD00B02E8_var*
var
 l_Linked : Bool;
//#UC END# *4A60A2CF0329_480DD00B02E8_var*
begin
//#UC START# *4A60A2CF0329_480DD00B02E8_impl*
 if (f_Owner <> Value) then
 begin
  l_Linked := Linked;
  Linked := false;
  f_Owner := Value As TWinControl;
  if (f_Owner <> nil) AND (l_Linked) then
   Linked := true;
  if not Linked AND (f_Owner <> nil) AND f_Owner.Focused then
   Linked := true;
 end;//f_Owner <> Value
//#UC END# *4A60A2CF0329_480DD00B02E8_impl*
end;//TafwSingleCaret.DoSetOwner
