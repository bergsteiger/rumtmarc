...
{$IfEnd} //not DesignTimeLibrary
 ...
 IafwPrinter = l3Interfaces.Il3Printer;
  {* Принтер. }
 ...
 IafwSettingsNotify = interface(IafwBase)
  {* Уведомляет о событиях настроек. }
   ['{F564FD0B-00C5-4669-BA45-713D8CED7A5B}']
 ...
 IafwWeightListner = interface(IafwBase)
 ...
 IafwSettings = interface(IafwSettingsPrim)
  {* интерфейс для работы с настройками. }
   ...
   procedure SaveDouble(const aSettingId: TafwSettingId;
    ...
    aDefault: Double = 0;
    aSetAsDefault: Boolean = False);
   property Notify: IafwSettingsNotify
     read pm_GetNotify;
     {* для подписки на события настроек. }
