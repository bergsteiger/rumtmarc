...
{ $Id: SPHtmlHelp.pas,v 1.6 2013/07/01 06:36:42 lulin Exp $ }
...
begin
 ...
 if (l_FileName <> '') then
 begin
  l_FullName := Format('%s\..\help\%s', [ExtractFileDir(ParamStr(0)), l_FileName]);
  ...
  begin
   ...
   begin
    l_FullName := Format('%s\%s', [ExtractFileDir(ParamStr(0)), l_FileName]);
