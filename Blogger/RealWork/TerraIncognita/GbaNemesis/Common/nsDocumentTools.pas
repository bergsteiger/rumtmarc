...
// $Id: nsDocumentTools.pas,v 1.21 2013/02/27 10:31:48 kostitsin Exp $
...
begin
 ...
 begin
  ...
  begin
   ...
   try
    l_Info := TnsDocumentPreview.Make(TnsIDocumentDataObject.Make(l_Rel), l_Key,
                TnsHAFPainter.Make(TevFormatHAFMacroReplacer.Make(l_HAF,
                  str_nevmmReference.AsCStr)));
    if ForLog and Supports(l_Info, InsEventHolder, l_Event) then
