...
type
 ...
 // private fields
   ...
   f_Presentation : InevTag;
    {* Представление ноды}
   f_CheckType : TnsEditionNodeCheckType;
 private
 // private methods
   function Presentation: InevTag;
...
function TnsEditionNode.Presentation: InevTag;
...
//#UC START# *4EC25E6B006A_4B1CE8B50207_impl*
 ...
 begin
  ...
  f_Presentation := k2_typTextPara.MakeTag;
  ...
  l_Segs := f_Presentation.cAtomEx([k2_tiSegments,
                                    k2_tiChildren, k2_tiHandle, ev_slView],
                                    nil);
  l_S := k2_typTextSegment.MakeTag;
  ...
  begin
   l_Block := k2_typNodeGroup.MakeTag;
   try
...
//#UC START# *4A60B23E00C3_4B1CE8B50207_impl*
 ...
 begin
  ...
  begin
   Result.SetOk;
   Il3NodePainter(Obj) := TevNodePainter.Make(l_P);
  end;//l_P = nil.. 
 end//IID.EQ(Il3NodePainter)
 else
 if IID.EQ(InevTag) then
 begin
  l_P := Presentation;
  if (l_P = nil) OR not l_P.IsValid then
   Result.SetNoInterface
...
function TnsEditionNode.IsSame(const aNode: Il3SimpleNode): Boolean;
//#UC START# *4ADEE0F60264_4B1CE8B50207_var*
var
 l_EditionNode : InsEditionNode;
//#UC END# *4ADEE0F60264_4B1CE8B50207_var*
begin
//#UC START# *4ADEE0F60264_4B1CE8B50207_impl*
...
//#UC END# *4ADEE0F60264_4B1CE8B50207_impl*
end;//TnsEditionNode.IsSame

procedure TnsEditionNode.ClearFields;
 {-}
begin
 f_Presentation := nil;
 inherited;
end;//TnsEditionNode.ClearFields
{$IfEnd} //not Admin AND not Monitorings
