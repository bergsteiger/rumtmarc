...
//#UC END# *4AF32FBD00F5ci*
 ...
 // private fields
   ...
   f_SelectedOnlyCheckBox : TeeCheckBox;
   f_ExtraPanel : TvtPanel;
   f_MergeCheckBox : TeeCheckBox;
   f_SaveFileName : AnsiString;
   f_TitlesRadio : TeeRadioButton;
   f_ContentsRadio : TeeRadioButton;
   f_NumbersRadio : TeeRadioButton;
   f_Executing : Boolean;
...
//#UC START# *4DD26A5D0253_4AF32FBD00F5_impl*
 SaveListTarget := TnsSaveDialogListTarget((Sender as TeeRadioButton).Tag);
 UpdateFileNameEditEnable;
...
//#UC START# *4DC2F34E0143_4AF32FBD00F5set_var*
 ...
 begin//lp_MakeDocumentPanel
  ...
  f_SelectedOnlyCheckBox := TeeCheckBox1.Create(f_ExtraPanel);
 ...
 begin//lp_MakeListPanel
  ...
  f_TitlesRadio := TeeRadioButton1.Create(f_ListTargetGroup);
  f_TitlesRadio.Tag := Ord(ns_sdlkTitles);
  l_GroupTop := lp_SetupControl(f_TitlesRadio, f_ListTargetGroup, l_GroupTop);

  f_ContentsRadio := TeeRadioButton1.Create(f_ListTargetGroup);
  ...
  f_MergeCheckBox := TeeCheckBox1.Create(f_ListTargetGroup);
  lp_SetupControl(f_MergeCheckBox, f_ListTargetGroup, l_CheckBoxTop);

  if MakeTopcNumberRadio then
  begin
   f_NumbersRadio := TeeRadioButton1.Create(f_ListTargetGroup);
