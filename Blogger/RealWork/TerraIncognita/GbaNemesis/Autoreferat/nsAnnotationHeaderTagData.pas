...
type
 ...
 // public methods
   ...
   class function Make(anIndex: Integer;
     const aDoc: IDocument;
     const anAnno: InevTag): If1TagDataProvider; reintroduce;
...
class function TnsAnnotationHeaderTagData.Make(anIndex: Integer;
  const aDoc: IDocument;
  const anAnno: InevTag): If1TagDataProvider;
var
...
function TnsAnnotationHeaderTagData.Get_TypeID: Integer;
...
//#UC START# *4C6EB48D0004_4D6E0D500395_impl*
 ...
 if theNode.InheritsFrom(k2_idDocument) then
