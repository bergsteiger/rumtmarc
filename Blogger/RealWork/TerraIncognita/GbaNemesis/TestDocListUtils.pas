...
(*  aDocument.GetTagStructureRoot(l_DocTagRoot);
  ...
  begin
    ...
    begin
      ...
      begin
        if (l_CurrNode.GetNodeId = aParaID) AND k2.TypeTable[l_CurrNode.GetType].InheritsFrom(k2_idLeafPara) then
      ...
      begin // параграф найден
        ...
        repeat
          ...
          begin
            ...
            while (l_CurrNode <> nil) do
            begin
              if k2.TypeTable[l_CurrNode.GetType].InheritsFrom(k2_idSub)
                AND (NOT k2.TypeTable[l_CurrNode.GetType].InheritsFrom(k2_idBookmark)) then
              begin // нашли саб
          ...
          begin
            ...
            begin
              ...
              if k2.TypeTable[l_CurrNode.GetType].InheritsFrom(k2_idLeafPara) then
              begin // нашли параграф
                l_ParaNode := l_CurrNode;
                break;
              end; //if
        ...
        begin // дочерний саб не найден, поэтому ищем родительский
          ...
          while (l_CurrNode <> nil) do
          begin
            if k2.TypeTable[l_CurrNode.GetType].InheritsFrom(k2_idSub) then
            begin // нашли саб
              l_SubNode := l_CurrNode;
              l_CurrNode := nil;
              break;
