...
// Модуль     : nsAdminInfo;
// Начат      : 20.05.2007
// Версия     : $Id: nsAdminInfo.pas,v 1.8 2013/04/24 09:35:55 lulin Exp $
...
begin
 ...
 begin
  f_Email := aValue;
  Autorization.SetAdministratorEmail(nsIStr(f_Email));
...
begin
 ...
 begin
  f_Phone := aValue;
  Autorization.SetAdministratorPhone(nsIStr(f_Phone));
