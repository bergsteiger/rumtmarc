...
//#UC START# *4AE718F90254_4C7E651B0179_impl*
 ...
 begin
  ...
  begin
   l_Coord  := FoldersTree.GetDrawTextRect(
   ...
   Result := (TdmStdRes.EditInfoOpen(IsNewFolder,
                                     aNode,
                                     TnsFormCoordinates.Make(l_Coord)) = mrOk);
...
//#UC START# *4C7E67CE01CB_4C7E651B0179exec_impl*
 OpenFolderElement(self.as_IvcmEntityForm, FoldersTree.GetCurrentNode);
...
//#UC START# *4C7E685801E5_4C7E651B0179exec_impl*
 OpenFolderElement(self.as_IvcmEntityForm, FoldersTree.GetCurrentNode, True);
