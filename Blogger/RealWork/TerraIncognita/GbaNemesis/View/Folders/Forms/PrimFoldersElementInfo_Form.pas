...
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimFoldersElementInfo_Control_CommentPanel
 Tkw_PrimFoldersElementInfo_Control_CommentPanel.Register('контрол::CommentPanel', TvtPanel);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimFoldersElementInfo_Control_CommentPanel_Push
 Tkw_PrimFoldersElementInfo_Control_CommentPanel_Push.Register('контрол::CommentPanel:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimFoldersElementInfo_Control_ElementComment
 Tkw_PrimFoldersElementInfo_Control_ElementComment.Register('контрол::ElementComment', TeeMemoWithEditOperations);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimFoldersElementInfo_Control_ElementComment_Push
 Tkw_PrimFoldersElementInfo_Control_ElementComment_Push.Register('контрол::ElementComment:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimFoldersElementInfo_Control_CaptionPanel
 Tkw_PrimFoldersElementInfo_Control_CaptionPanel.Register('контрол::CaptionPanel', TvtPanel);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimFoldersElementInfo_Control_CaptionPanel_Push
 Tkw_PrimFoldersElementInfo_Control_CaptionPanel_Push.Register('контрол::CaptionPanel:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimFoldersElementInfo_Control_lblComment
 Tkw_PrimFoldersElementInfo_Control_lblComment.Register('контрол::lblComment', TvtLabel);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimFoldersElementInfo_Control_lblComment_Push
 Tkw_PrimFoldersElementInfo_Control_lblComment_Push.Register('контрол::lblComment:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimFoldersElementInfo_Control_TopPanel
 Tkw_PrimFoldersElementInfo_Control_TopPanel.Register('контрол::TopPanel', TvtPanel);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimFoldersElementInfo_Control_TopPanel_Push
 Tkw_PrimFoldersElementInfo_Control_TopPanel_Push.Register('контрол::TopPanel:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimFoldersElementInfo_Control_NamePanel
 Tkw_PrimFoldersElementInfo_Control_NamePanel.Register('контрол::NamePanel', TvtPanel);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimFoldersElementInfo_Control_NamePanel_Push
 Tkw_PrimFoldersElementInfo_Control_NamePanel_Push.Register('контрол::NamePanel:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimFoldersElementInfo_Control_lblElementName
 Tkw_PrimFoldersElementInfo_Control_lblElementName.Register('контрол::lblElementName', TvtLabel);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimFoldersElementInfo_Control_lblElementName_Push
 Tkw_PrimFoldersElementInfo_Control_lblElementName_Push.Register('контрол::lblElementName:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimFoldersElementInfo_Control_ElementName
 Tkw_PrimFoldersElementInfo_Control_ElementName.Register('контрол::ElementName', TnscComboBoxWithReadOnly);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimFoldersElementInfo_Control_ElementName_Push
 Tkw_PrimFoldersElementInfo_Control_ElementName_Push.Register('контрол::ElementName:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimFoldersElementInfo_Control_cbShared
 Tkw_PrimFoldersElementInfo_Control_cbShared.Register('контрол::cbShared', TeeCheckBox);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimFoldersElementInfo_Control_cbShared_Push
 Tkw_PrimFoldersElementInfo_Control_cbShared_Push.Register('контрол::cbShared:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimFoldersElementInfo_Control_InfoName
 Tkw_PrimFoldersElementInfo_Control_InfoName.Register('контрол::InfoName', TvtLabel);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimFoldersElementInfo_Control_InfoName_Push
 Tkw_PrimFoldersElementInfo_Control_InfoName_Push.Register('контрол::InfoName:push');
{$IfEnd} //not Admin AND not Monitorings
