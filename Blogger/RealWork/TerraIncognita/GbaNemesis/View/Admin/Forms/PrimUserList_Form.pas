...
//
// Форма для отображения списка пользователей
//
//
...
{$IfEnd} //Admin
{$If defined(Admin)}
// Регистрация Tkw_PrimUserList_Control_trUserList
 Tkw_PrimUserList_Control_trUserList.Register('контрол::trUserList', TeeTreeView);
{$IfEnd} //Admin
{$If defined(Admin)}
// Регистрация Tkw_PrimUserList_Control_trUserList_Push
 Tkw_PrimUserList_Control_trUserList_Push.Register('контрол::trUserList:push');
{$IfEnd} //Admin
{$If defined(Admin)}
// Регистрация Tkw_PrimUserList_Control_ContextFilter
 Tkw_PrimUserList_Control_ContextFilter.Register('контрол::ContextFilter', TnscContextFilter);
{$IfEnd} //Admin
{$If defined(Admin)}
// Регистрация Tkw_PrimUserList_Control_ContextFilter_Push
 Tkw_PrimUserList_Control_ContextFilter_Push.Register('контрол::ContextFilter:push');
{$IfEnd} //Admin
{$If defined(Admin)}
