...
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimMedicFirmList_Control_BackgroundPanel
 Tkw_PrimMedicFirmList_Control_BackgroundPanel.Register('контрол::BackgroundPanel', TvtPanel);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimMedicFirmList_Control_BackgroundPanel_Push
 Tkw_PrimMedicFirmList_Control_BackgroundPanel_Push.Register('контрол::BackgroundPanel:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimMedicFirmList_Control_ContextFilter
 Tkw_PrimMedicFirmList_Control_ContextFilter.Register('контрол::ContextFilter', TnscContextFilter);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimMedicFirmList_Control_ContextFilter_Push
 Tkw_PrimMedicFirmList_Control_ContextFilter_Push.Register('контрол::ContextFilter:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimMedicFirmList_Control_ListTree
 Tkw_PrimMedicFirmList_Control_ListTree.Register('контрол::ListTree', TnscTreeView);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimMedicFirmList_Control_ListTree_Push
 Tkw_PrimMedicFirmList_Control_ListTree_Push.Register('контрол::ListTree:push');
{$IfEnd} //not Admin AND not Monitorings
