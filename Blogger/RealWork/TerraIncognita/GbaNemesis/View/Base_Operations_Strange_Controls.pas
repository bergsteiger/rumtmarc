...
(* Document = operations(Document)
   ...
   query AddBookmarkFromContents(const aTag: InevTag);
   query OpenNotSureTopic;
   query GotoPara(const aPara: InevTag;
...
type
 ...
 IDocument_AddBookmarkFromContents_Params = interface(IUnknown)
  {* Параметры для операции Document.AddBookmarkFromContents }
   ...
   function Get_Tag: InevTag;
   property Tag: InevTag
     read Get_Tag;
     {* undefined }
 ...
 // public methods
   class function Call(const aTarget: IvcmEntity;
    const aTag: InevTag): Boolean; overload; 
...
type
 ...
 // public methods
   ...
   class function Make(const aTag: InevTag): IDocument_AddBookmarkFromContents_Params; reintroduce;
...
constructor TDocument_AddBookmarkFromContents_Params.Create(const aTag: InevTag);
 {-}
begin
 inherited Create;
 f_Tag := aTag;
...
class function TDocument_AddBookmarkFromContents_Params.Make(const aTag: InevTag): IDocument_AddBookmarkFromContents_Params;
var
...
function TDocument_AddBookmarkFromContents_Params.Get_Tag: InevTag;
 {-}
begin
 Result := f_Tag;
...
type
 ...
 public
 // public methods
   constructor Create(const aPara: InevTag;
    aUserType: Integer); reintroduce;
     {* Конструктор TDocument_GotoPara_Params }
   class function Make(const aPara: InevTag;
...
constructor TDocument_GotoPara_Params.Create(const aPara: InevTag;
  aUserType: Integer);
 {-}
begin
 inherited Create;
...
class function TDocument_GotoPara_Params.Make(const aPara: InevTag;
...
function TDocument_GotoPara_Params.Get_Para: InevTag;
 {-}
begin
 Result := f_Para;
