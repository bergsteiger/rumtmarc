...
var
 ...
 l_Para : InevObject; // Текущий верхний параграф
...
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_Diff_Control_Header
 Tkw_Diff_Control_Header.Register('контрол::Header', TvtPanel);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_Diff_Control_Header_Push
 Tkw_Diff_Control_Header_Push.Register('контрол::Header:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_Diff_Control_pnLeft
 Tkw_Diff_Control_pnLeft.Register('контрол::pnLeft', TvtPanel);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_Diff_Control_pnLeft_Push
 Tkw_Diff_Control_pnLeft_Push.Register('контрол::pnLeft:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_Diff_Control_EditionLink
 Tkw_Diff_Control_EditionLink.Register('контрол::EditionLink', TvtFocusLabel);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_Diff_Control_EditionLink_Push
 Tkw_Diff_Control_EditionLink_Push.Register('контрол::EditionLink:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_Diff_Control_pbIcon
 Tkw_Diff_Control_pbIcon.Register('контрол::pbIcon', TPaintBox);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_Diff_Control_pbIcon_Push
 Tkw_Diff_Control_pbIcon_Push.Register('контрол::pbIcon:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_Diff_Control_pnCaption
 Tkw_Diff_Control_pnCaption.Register('контрол::pnCaption', TvtPanel);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_Diff_Control_pnCaption_Push
 Tkw_Diff_Control_pnCaption_Push.Register('контрол::pnCaption:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_Diff_Control_EditionChoose
 Tkw_Diff_Control_EditionChoose.Register('контрол::EditionChoose', TvtComboBoxQS);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_Diff_Control_EditionChoose_Push
 Tkw_Diff_Control_EditionChoose_Push.Register('контрол::EditionChoose:push');
{$IfEnd} //not Admin AND not Monitorings
