...
{$If not defined(Admin) AND not defined(Monitorings)}
type
 _StatusBarItems_Parent_ = TvcmContainerForm;
 ...
 TPrimEditionsContainerForm = {form} class(_EditionsListCaller_, InsVScrollListner)
  {* Контейнер для двух редакций }
 private
 // private fields
...
type
  Tkw_PrimEditionsContainer_Control_BackgroundPanel = class(TtfwControlString)
...
[code] }
  ...
  // overridden protected methods
   ...
   function GetString: AnsiString; override;
    {$IfEnd} //not NoScripts
  end;//Tkw_PrimEditionsContainer_Control_BackgroundPanel

// start class Tkw_PrimEditionsContainer_Control_BackgroundPanel

{$If not defined(NoScripts)}
function Tkw_PrimEditionsContainer_Control_BackgroundPanel.GetString: AnsiString;
 {-}
begin
 Result := 'BackgroundPanel';
end;//Tkw_PrimEditionsContainer_Control_BackgroundPanel.GetString
{$IfEnd} //not NoScripts

type
  Tkw_PrimEditionsContainer_Control_BackgroundPanel_Push = class(TkwBynameControlPush)
...
[code] }
  ...
  // overridden protected methods
   ...
   procedure DoDoIt(const aCtx: TtfwContext); override;
    {$IfEnd} //not NoScripts
  end;//Tkw_PrimEditionsContainer_Control_BackgroundPanel_Push

// start class Tkw_PrimEditionsContainer_Control_BackgroundPanel_Push

{$If not defined(NoScripts)}
procedure Tkw_PrimEditionsContainer_Control_BackgroundPanel_Push.DoDoIt(const aCtx: TtfwContext);
 {-}
begin
 aCtx.rEngine.PushString('BackgroundPanel');
 inherited;
end;//Tkw_PrimEditionsContainer_Control_BackgroundPanel_Push.DoDoIt
{$IfEnd} //not NoScripts

type
  Tkw_PrimEditionsContainer_Control_pnLeft = class(TtfwControlString)
...
[code] }
  ...
  // overridden protected methods
   ...
   function GetString: AnsiString; override;
    {$IfEnd} //not NoScripts
  end;//Tkw_PrimEditionsContainer_Control_pnLeft

// start class Tkw_PrimEditionsContainer_Control_pnLeft

{$If not defined(NoScripts)}
function Tkw_PrimEditionsContainer_Control_pnLeft.GetString: AnsiString;
 {-}
begin
 Result := 'pnLeft';
end;//Tkw_PrimEditionsContainer_Control_pnLeft.GetString
{$IfEnd} //not NoScripts

type
  Tkw_PrimEditionsContainer_Control_pnLeft_Push = class(TkwBynameControlPush)
...
[code] }
  ...
  // overridden protected methods
   ...
   procedure DoDoIt(const aCtx: TtfwContext); override;
    {$IfEnd} //not NoScripts
  end;//Tkw_PrimEditionsContainer_Control_pnLeft_Push

// start class Tkw_PrimEditionsContainer_Control_pnLeft_Push

{$If not defined(NoScripts)}
procedure Tkw_PrimEditionsContainer_Control_pnLeft_Push.DoDoIt(const aCtx: TtfwContext);
 {-}
begin
 aCtx.rEngine.PushString('pnLeft');
 inherited;
end;//Tkw_PrimEditionsContainer_Control_pnLeft_Push.DoDoIt
{$IfEnd} //not NoScripts

type
  Tkw_PrimEditionsContainer_Control_pnRight = class(TtfwControlString)
...
[code] }
  ...
  // overridden protected methods
   ...
   function GetString: AnsiString; override;
    {$IfEnd} //not NoScripts
  end;//Tkw_PrimEditionsContainer_Control_pnRight

// start class Tkw_PrimEditionsContainer_Control_pnRight

{$If not defined(NoScripts)}
function Tkw_PrimEditionsContainer_Control_pnRight.GetString: AnsiString;
 {-}
begin
 Result := 'pnRight';
end;//Tkw_PrimEditionsContainer_Control_pnRight.GetString
{$IfEnd} //not NoScripts

type
  Tkw_PrimEditionsContainer_Control_pnRight_Push = class(TkwBynameControlPush)
...
[code] }
  ...
  // overridden protected methods
   ...
   procedure DoDoIt(const aCtx: TtfwContext); override;
    {$IfEnd} //not NoScripts
  end;//Tkw_PrimEditionsContainer_Control_pnRight_Push

// start class Tkw_PrimEditionsContainer_Control_pnRight_Push

{$If not defined(NoScripts)}
procedure Tkw_PrimEditionsContainer_Control_pnRight_Push.DoDoIt(const aCtx: TtfwContext);
 {-}
begin
 aCtx.rEngine.PushString('pnRight');
 inherited;
end;//Tkw_PrimEditionsContainer_Control_pnRight_Push.DoDoIt
{$IfEnd} //not NoScripts
...
//#UC START# *4A80256B02A5_4A6EC0D0020C_impl*
 ...
 begin
  ...
  CCaption := l3Cat([l3Trim(l_P), l3CStr(' : '), EditionsContainerData.DocumentNameForCaption]);
...
initialization
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimEditionsContainer_Control_BackgroundPanel
 Tkw_PrimEditionsContainer_Control_BackgroundPanel.Register('контрол::BackgroundPanel', TvtProportionalPanel);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimEditionsContainer_Control_BackgroundPanel_Push
 Tkw_PrimEditionsContainer_Control_BackgroundPanel_Push.Register('контрол::BackgroundPanel:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimEditionsContainer_Control_pnLeft
 Tkw_PrimEditionsContainer_Control_pnLeft.Register('контрол::pnLeft', TvtSizeablePanel);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimEditionsContainer_Control_pnLeft_Push
 Tkw_PrimEditionsContainer_Control_pnLeft_Push.Register('контрол::pnLeft:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimEditionsContainer_Control_pnRight
 Tkw_PrimEditionsContainer_Control_pnRight.Register('контрол::pnRight', TvtPanel);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimEditionsContainer_Control_pnRight_Push
 Tkw_PrimEditionsContainer_Control_pnRight_Push.Register('контрол::pnRight:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
