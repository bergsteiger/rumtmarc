...
initialization
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimMainMenu_Control_pnlMain
 Tkw_PrimMainMenu_Control_pnlMain.Register('контрол::pnlMain', TvtPanel);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimMainMenu_Control_pnlMain_Push
 Tkw_PrimMainMenu_Control_pnlMain_Push.Register('контрол::pnlMain:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimMainMenu_Control_hfLastOpenDocs
 Tkw_PrimMainMenu_Control_hfLastOpenDocs.Register('контрол::hfLastOpenDocs', TnscHideField);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimMainMenu_Control_hfLastOpenDocs_Push
 Tkw_PrimMainMenu_Control_hfLastOpenDocs_Push.Register('контрол::hfLastOpenDocs:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimMainMenu_Control_tvLastOpenDocs
 Tkw_PrimMainMenu_Control_tvLastOpenDocs.Register('контрол::tvLastOpenDocs', TnscTreeViewHotTruck);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimMainMenu_Control_tvLastOpenDocs_Push
 Tkw_PrimMainMenu_Control_tvLastOpenDocs_Push.Register('контрол::tvLastOpenDocs:push');
{$IfEnd} //not Admin AND not Monitorings
