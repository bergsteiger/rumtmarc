...
//#UC START# *4F82B4EE0330_4C46AA3401DB_impl*
 ...
 BringRemindersToFront; // костыль к 348685171
...
initialization
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimListOptions_Control_remListFiltered
 Tkw_PrimListOptions_Control_remListFiltered.Register('контрол::remListFiltered', TnscReminder);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimListOptions_Control_remListFiltered_Push
 Tkw_PrimListOptions_Control_remListFiltered_Push.Register('контрол::remListFiltered:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimListOptions_Control_remListModified
 Tkw_PrimListOptions_Control_remListModified.Register('контрол::remListModified', TnscReminder);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimListOptions_Control_remListModified_Push
 Tkw_PrimListOptions_Control_remListModified_Push.Register('контрол::remListModified:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimListOptions_Control_remTimeMachineWarning
 Tkw_PrimListOptions_Control_remTimeMachineWarning.Register('контрол::remTimeMachineWarning', TnscReminder);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimListOptions_Control_remTimeMachineWarning_Push
 Tkw_PrimListOptions_Control_remTimeMachineWarning_Push.Register('контрол::remTimeMachineWarning:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimListOptions_Component_RemindersLine
 Tkw_PrimListOptions_Component_RemindersLine.Register('компонент::RemindersLine', TnscRemindersLine);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimListOptions_Control_EmptyListEditor
 Tkw_PrimListOptions_Control_EmptyListEditor.Register('контрол::EmptyListEditor', TnscEditor);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimListOptions_Control_EmptyListEditor_Push
 Tkw_PrimListOptions_Control_EmptyListEditor_Push.Register('контрол::EmptyListEditor:push');
{$IfEnd} //not Admin AND not Monitorings
