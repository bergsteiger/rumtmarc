...
type
 ...
 // private methods
   ...
   procedure TvListCurrentIndexChanged(const aNew: Integer;
     const anOld: Integer);
 ...
 // realized methods
   ...
   procedure LftRCToPartQueryMaximized(aSender: TObject); override;
     {* Обработчик события lftRCToPart.OnQueryMaximized }
   procedure LftRCToPartQueryOpen(aSender: TObject); override;
     {* Обработчик события lftRCToPart.OnQueryOpen }
 public
 // realized methods
...
{$IfEnd} //not Admin AND not Monitorings
  ...
  {$If not defined(Admin) AND not defined(Monitorings)}
var
   g_OverrideList : Integer;
  {$IfEnd} //not Admin AND not Monitorings
  {$If not defined(Admin) AND not defined(Monitorings)}
var
   g_SaveToFolders : Integer;
  {$IfEnd} //not Admin AND not Monitorings
  {$If not defined(Admin) AND not defined(Monitorings)}
var
   g_SaveToFoldersSelected : Integer;
  {$IfEnd} //not Admin AND not Monitorings
...
type
  Tkw_PrimList_Control_ListPanel = class(TtfwControlString)
...
[code] }
  ...
  // overridden protected methods
   ...
   function GetString: AnsiString; override;
    {$IfEnd} //not NoScripts
  end;//Tkw_PrimList_Control_ListPanel

// start class Tkw_PrimList_Control_ListPanel

{$If not defined(NoScripts)}
function Tkw_PrimList_Control_ListPanel.GetString: AnsiString;
 {-}
begin
 Result := 'ListPanel';
end;//Tkw_PrimList_Control_ListPanel.GetString
{$IfEnd} //not NoScripts

type
  Tkw_PrimList_Control_ListPanel_Push = class(TkwBynameControlPush)
...
[code] }
  ...
  // overridden protected methods
   ...
   procedure DoDoIt(const aCtx: TtfwContext); override;
    {$IfEnd} //not NoScripts
  end;//Tkw_PrimList_Control_ListPanel_Push

// start class Tkw_PrimList_Control_ListPanel_Push

{$If not defined(NoScripts)}
procedure Tkw_PrimList_Control_ListPanel_Push.DoDoIt(const aCtx: TtfwContext);
 {-}
begin
 aCtx.rEngine.PushString('ListPanel');
 inherited;
end;//Tkw_PrimList_Control_ListPanel_Push.DoDoIt
{$IfEnd} //not NoScripts

type
  Tkw_PrimList_Control_tvList = class(TtfwControlString)
...
[code] }
  ...
  // overridden protected methods
   ...
   function GetString: AnsiString; override;
    {$IfEnd} //not NoScripts
  end;//Tkw_PrimList_Control_tvList

// start class Tkw_PrimList_Control_tvList

{$If not defined(NoScripts)}
function Tkw_PrimList_Control_tvList.GetString: AnsiString;
 {-}
begin
 Result := 'tvList';
end;//Tkw_PrimList_Control_tvList.GetString
{$IfEnd} //not NoScripts

type
  Tkw_PrimList_Control_tvList_Push = class(TkwBynameControlPush)
...
[code] }
  ...
  // overridden protected methods
   ...
   procedure DoDoIt(const aCtx: TtfwContext); override;
    {$IfEnd} //not NoScripts
  end;//Tkw_PrimList_Control_tvList_Push

// start class Tkw_PrimList_Control_tvList_Push

{$If not defined(NoScripts)}
procedure Tkw_PrimList_Control_tvList_Push.DoDoIt(const aCtx: TtfwContext);
 {-}
begin
 aCtx.rEngine.PushString('tvList');
 inherited;
end;//Tkw_PrimList_Control_tvList_Push.DoDoIt
{$IfEnd} //not NoScripts

type
  Tkw_PrimList_Control_cfList = class(TtfwControlString)
...
[code] }
  ...
  // overridden protected methods
   ...
   function GetString: AnsiString; override;
    {$IfEnd} //not NoScripts
  end;//Tkw_PrimList_Control_cfList

// start class Tkw_PrimList_Control_cfList

{$If not defined(NoScripts)}
function Tkw_PrimList_Control_cfList.GetString: AnsiString;
 {-}
begin
 Result := 'cfList';
end;//Tkw_PrimList_Control_cfList.GetString
{$IfEnd} //not NoScripts

type
  Tkw_PrimList_Control_cfList_Push = class(TkwBynameControlPush)
...
[code] }
  ...
  // overridden protected methods
   ...
   procedure DoDoIt(const aCtx: TtfwContext); override;
    {$IfEnd} //not NoScripts
  end;//Tkw_PrimList_Control_cfList_Push

// start class Tkw_PrimList_Control_cfList_Push

{$If not defined(NoScripts)}
procedure Tkw_PrimList_Control_cfList_Push.DoDoIt(const aCtx: TtfwContext);
 {-}
begin
 aCtx.rEngine.PushString('cfList');
 inherited;
end;//Tkw_PrimList_Control_cfList_Push.DoDoIt
{$IfEnd} //not NoScripts
...
procedure TPrimListForm.TvListCurrentIndexChanged(const aNew: Integer;
  const anOld: Integer);
...
const
 cListNodeTypeImageHint : array [TbsListNodeType] of PvcmStringID = (
  @str_Empty, // lntUnknown,
  @str_lntBlock, // lntBlock
  @str_lntDocActive, // lntDocActive
  @str_lntDocPreActive, // lntDocPreActive
  @str_lntDocAbolished, // lntDocAbolished
  @str_Empty, // lntExternalObject
  @str_Empty, // lntExternalLink
  @str_lntRedaction, // lntRedaction
  @str_lntRedactions, // lntRedactions
  @str_lntDrugAnnuled, // lntDrugAnnuled,
  @str_lntDrugNarcotic, // lntDrugNarcotic,
  @str_lntDrugNoAnnuledNoNarcoric, // lntDrugNoAnnuledNoNarcoric,
  @str_lntFormAnnuled, // lntFormAnnuled,
  @str_lntFormRussianImportant, // lntFormRussianImportant,
  @str_lntFormNoRussianImportant, // lntFormNoRussianImportant,
  @str_lntFormRussianNoImportant, // lntFormRussianNoImportant,
  @str_lntFormNoRussianNoImportant, // lntFormNoRussianNoImportant
  nil,
  nil
 );
var
...
//#UC START# *4F7EEF8500A8_497DDB2B001B_impl*
 ...
 begin
  ...
  case l_NT of
   ...
   if Assigned(cListNodeTypeImageHint[l_NT]) then
    Result := vcmCStr(cListNodeTypeImageHint[l_NT]^);
  end;
 end;
 ...
 begin
  ...
  try
   ...
   try
    ...
    if afw.Settings.LoadBoolean(pi_List_OpenInNewWindow, dv_Document_OpenInNewWindow) then
    begin
    ...
    // Открывать документы в текущем окне
    else
     l_Cont := NativeMainForm;
    OpenDocument(l_DataInfo, l_Cont);
   finally
...
//#UC START# *4C528A1900DC_497DDB2B001B_impl*
 with tvList.TreeView do
  aParams.Op.Flag[vcm_ofEnabled] := lp_IsValidDocument and
   NoMoreThanOneSelected and IsHasCurrent;
...
class procedure TnsOpenDocumentFromListEvent.Log(const aDoc: IDocument;
  aNumber: Integer;
  aRelevance: Integer);
//#UC START# *4B0A69AE00EB_4B0A69600050_var*
var
 l_Data: ILogEventData;
//#UC END# *4B0A69AE00EB_4B0A69600050_var*
begin
//#UC START# *4B0A69AE00EB_4B0A69600050_impl*
...
//#UC END# *4B0A69AE00EB_4B0A69600050_impl*
...
function TPrimListForm.IsHasCurrent: Boolean;
...
end;//TPrimListForm.IsHasCurrent
...
//#UC START# *4B0A69100289_497DDB2B001B_var*
 ...
 procedure lp_MakeCurrentInfo(var aRelevance, aNumber: Integer);
 var
  l_ListEntry: IListEntryInfo;
 ...
 begin//lp_RegisterEvent
  ...
  begin
   lp_MakeCurrentInfo(l_Relevance, l_Number);
    // - информация о текущем.
   TnsOpenDocumentFromListEvent.Log(aDoc.Doc, l_Number, l_Relevance);
  end;//if aDoc.Doc.GetDocType = DT_DOCUMENT then
...
//#UC START# *4B5580C902B0_497DDB2B001B_impl*
 aParams.Op.Flag[vcm_ofEnabled] := Assigned(dsList) and
  not IsListEmpty and IsHasCurrent;
...
//#UC START# *498863B203D0_497DDB2B001Btest_impl*
 aParams.Op.Flag[vcm_ofEnabled] := IsHasCurrent and Assigned(dsDocumentList) and dsDocumentList.CanAddToControl;
...
//#UC START# *498863B203D0_497DDB2B001Bgetstate_impl*
 if IsHasCurrent and OnlyOneSelected and Assigned(dsDocumentList) and dsDocumentList.IsUnderControl then
 ...
 begin
  if Assigned(dsList) then
   try
    ...
    if dsList.ApplyLogicOperation(l_Object, anOp) then
    begin
...
//#UC START# *498993C801DC_497DDB2B001Btest_impl*
 with tvList.TreeView do
  aParams.Op.Flag[vcm_ofEnabled] := NoMoreThanOneSelected and IsHasCurrent and
...
//#UC START# *4C3716C50005_497DDB2B001Btest_impl*
 ...
 if (tvList.TreeView.Current < 0) or ((dsDocumentList = nil) or
  (dsDocumentList.IsListEmpty)) then
   aParams.Op.Flag[vcm_ofEnabled] := False
 else
 begin
  if Assigned(dsDocumentList) then
  begin
   ...
   try
    if (l_Strings <> nil) and ((l_Strings.Count = 0) or l_Res) and
...
//#UC START# *4C3716D1012E_497DDB2B001Btest_impl*
 //http://mdp.garant.ru/pages/viewpage.action?pageId=476813620
 aParams.Op.Flag[vcm_ofEnabled] := (IsHasCurrent and Assigned(dsDocumentList)) and
  (not dsDocumentList.IsListEmpty);
...
//#UC START# *4C3716D1012E_497DDB2B001Bgetstate_impl*
 if IsHasCurrent and Assigned(dsDocumentList) then
...
//#UC START# *4C3716E20109_497DDB2B001Bexec_impl*
 if (dsList.ListType = bs_ltDocument) then
  ...
  TdmStdRes.InpharmSearch(nil, dsList.List);
...
//#UC START# *4C3A96BD0239_497DDB2B001Btest_impl*
 aParams.Op.Flag[vcm_ofEnabled] := defDataAdapter.IsExists_PublishSourceTag and
  Assigned(dsDocumentList) and not dsDocumentList.IsListEmpty and IsHasCurrent;
...
//#UC START# *4C810A2702D9_497DDB2B001Bexec_impl*
 TdmStdRes.AttributeSearch(nil, dsList.List);
...
procedure TPrimListForm.LftRCToPartQueryMaximized(aSender: TObject);
...
end;//TPrimListForm.LftRCToPartQueryMaximized

procedure TPrimListForm.LftRCToPartQueryOpen(aSender: TObject);
...
end;//TPrimListForm.LftRCToPartQueryOpen
...
begin
 ...
 begin
  ...
  ShowInContextMenu(en_LocalList, op_Open, true);
 ...
 AddUserTypeExclude(lftRCToPartName, en_TimeMachine, op_TimeMachineOffAndReset, false);
 ...
 AddUserTypeExclude(lftRCToPartName, en_List, op_SetCurrentVisible, false);
 ...
 AddUserTypeExclude(lftRCToPartName, en_List, op_ListInfo, false);
 ...
 AddUserTypeExclude(lftRCToPartName, en_Filters, op_FiltersListOpen, false);
 ...
 AddUserTypeExclude(lftRCToPartName, en_File, op_LoadFromFolder, false);
 ...
 AddUserTypeExclude(lftRCToPartName, en_Filters, op_FiltersList, false);
 ...
 AddUserTypeExclude(lftRCToPartName, en_Filters, op_Clear, false);
 ...
 AddUserTypeExclude(lftRCToPartName, en_Filters, op_InternalClear, false);
 ...
 AddUserTypeExclude(lftRCToPartName, en_LocalList, op_SearchDrugInList, false);
 ...
 AddUserTypeExclude(lftRCToPartName, en_Selection, op_Analize, false);
 ...
 AddUserTypeExclude(lftRCToPartName, en_Document, op_GetAttributesFrmAct, false);
 ...
 AddUserTypeExclude(lftRCToPartName, en_Document, op_GetRelatedDocFrmAct, false);
...
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimList_Control_ListPanel
 Tkw_PrimList_Control_ListPanel.Register('контрол::ListPanel', TvtPanel);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimList_Control_ListPanel_Push
 Tkw_PrimList_Control_ListPanel_Push.Register('контрол::ListPanel:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimList_Control_tvList
 Tkw_PrimList_Control_tvList.Register('контрол::tvList', TnscDocumentListTreeView);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimList_Control_tvList_Push
 Tkw_PrimList_Control_tvList_Push.Register('контрол::tvList:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimList_Control_cfList
 Tkw_PrimList_Control_cfList.Register('контрол::cfList', TnscContextFilter);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimList_Control_cfList_Push
 Tkw_PrimList_Control_cfList_Push.Register('контрол::cfList:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
