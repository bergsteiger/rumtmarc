...
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimListInfo_Control_ListInfoViewer
 Tkw_PrimListInfo_Control_ListInfoViewer.Register('контрол::ListInfoViewer', TnscEditor);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimListInfo_Control_ListInfoViewer_Push
 Tkw_PrimListInfo_Control_ListInfoViewer_Push.Register('контрол::ListInfoViewer:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimListInfo_Component_TextSource
 Tkw_PrimListInfo_Component_TextSource.Register('компонент::TextSource', TnscTextSource);
{$IfEnd} //not Admin AND not Monitorings
