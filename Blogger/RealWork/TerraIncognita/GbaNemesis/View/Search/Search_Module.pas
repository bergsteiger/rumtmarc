...
type
  Tkw_TreeAttributeFirstLevel_FirstLevelContent_ControlInstance = class(TtfwWord)
   {* Слово словаря для доступа к экземпляру контрола FirstLevelContent формы TreeAttributeFirstLevel }
  protected
  // realized methods
    {$If not defined(NoScripts)}
...
type
  Tkw_OldSituationSearch_ContextFilter_ControlInstance = class(TtfwWord)
   {* Слово словаря для доступа к экземпляру контрола ContextFilter формы OldSituationSearch }
  protected
  // realized methods
    {$If not defined(NoScripts)}
   procedure DoDoIt(const aCtx: TtfwContext); override;
...
// Регистрация Tkw_Form_TreeAttributeFirstLevel
 Tkw_Form_TreeAttributeFirstLevel.Register('форма::TreeAttributeFirstLevel', TefTreeAttributeFirstLevel);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_TreeAttributeFirstLevel_FirstLevelContent_ControlInstance
...
// Регистрация Tkw_Form_OldSituationSearch
 Tkw_Form_OldSituationSearch.Register('форма::OldSituationSearch', TcfOldSituationSearch);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_OldSituationSearch_ContextFilter_ControlInstance
