...
//
// Библиотека "View"
// Модуль: "w:/garant6x/implementation/Garant/GbaNemesis/View/Search/kw_Search_InpharmSearch.pas"
// Родные Delphi интерфейсы (.pas)
// Generated from UML model, root element: <<SimpleClass::Class>> F1 Основные прецеденты::Search::View::Search::Tkw_Search_InpharmSearch
//
// Слово словаря для вызова операции модуля Search.InpharmSearch$Op (Поиск Поиск лекарственного
// средства)
//
//
...
type
 ...
 Tkw_Search_InpharmSearch = class(_tfwModuleOperationWord_)
  {* Слово словаря для вызова операции модуля Search.InpharmSearch$Op (Поиск Поиск лекарственного средства) }
 protected
...
class function Tkw_Search_InpharmSearch.GetWordNameForRegister: AnsiString;
 {-}
begin
 Result := 'моп::Поиск_Поиск_лекарственного_средства';
