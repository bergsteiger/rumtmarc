...
{ $Id: PrintDialog_Form.pas,v 1.15 2013/01/22 15:59:20 kostitsin Exp $ }
...
// - evGraph и Preview полностью переведены с класса TPrinter на интерфейс Il3Printer.
//
...
uses
  ...
  eeButton, eeCheckBox, absdrop,
  treedrop, vtComboBoxQS, OvcBase,  vcmComponent,
...
type
  Ten_PrintDialog = class(TvcmEntityFormRef)
    ...
    lbOddEven: TvtLabel;
    rbPrintAll: TeeRadioButton;
    rbPrintCurrent: TeeRadioButton;
    rbPrintSelected: TeeRadioButton;
    rbPrintInterval: TeeRadioButton;
    ...
    CollateCheckBox: TeeCheckBox;
    edCopyCount: TvtSpinEdit;
    Entities: TvcmEntities;
    CollateImageList: TvtNonFixedPngImageList;
    PrintObjectsGroupBox: TvtGroupBox;
    poDocumentNames: TeeRadioButton;
    poDocumentTexts: TeeRadioButton;
    cbPrintInfo: TeeCheckBox;
