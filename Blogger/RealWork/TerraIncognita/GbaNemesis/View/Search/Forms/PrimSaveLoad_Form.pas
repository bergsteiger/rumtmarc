...
initialization
{$If not defined(Admin)}
// Регистрация Tkw_PrimSaveLoad_Control_pnHeader
 Tkw_PrimSaveLoad_Control_pnHeader.Register('контрол::pnHeader', TvtPanel);
{$IfEnd} //not Admin
{$If not defined(Admin)}
// Регистрация Tkw_PrimSaveLoad_Control_pnHeader_Push
 Tkw_PrimSaveLoad_Control_pnHeader_Push.Register('контрол::pnHeader:push');
{$IfEnd} //not Admin
{$If not defined(Admin)}
// Регистрация Tkw_PrimSaveLoad_Control_lbHeader
 Tkw_PrimSaveLoad_Control_lbHeader.Register('контрол::lbHeader', TvtLabel);
{$IfEnd} //not Admin
{$If not defined(Admin)}
// Регистрация Tkw_PrimSaveLoad_Control_lbHeader_Push
 Tkw_PrimSaveLoad_Control_lbHeader_Push.Register('контрол::lbHeader:push');
{$IfEnd} //not Admin
{$If not defined(Admin)}
// Регистрация Tkw_PrimSaveLoad_Control_pbHeader
 Tkw_PrimSaveLoad_Control_pbHeader.Register('контрол::pbHeader', TPaintBox);
{$IfEnd} //not Admin
{$If not defined(Admin)}
// Регистрация Tkw_PrimSaveLoad_Control_pbHeader_Push
 Tkw_PrimSaveLoad_Control_pbHeader_Push.Register('контрол::pbHeader:push');
{$IfEnd} //not Admin
{$If not defined(Admin)}
// Регистрация Tkw_PrimSaveLoad_Control_ParentZone
 Tkw_PrimSaveLoad_Control_ParentZone.Register('контрол::ParentZone', TvtPanel);
{$IfEnd} //not Admin
{$If not defined(Admin)}
// Регистрация Tkw_PrimSaveLoad_Control_ParentZone_Push
 Tkw_PrimSaveLoad_Control_ParentZone_Push.Register('контрол::ParentZone:push');
{$IfEnd} //not Admin
{$If not defined(Admin)}
