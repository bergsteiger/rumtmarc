...
type
  Tkw_BaseTextOperations_Control_Text = class(TtfwControlString)
...
[code] }
  ...
  // overridden protected methods
   ...
   function GetString: AnsiString; override;
    {$IfEnd} //not NoScripts
  end;//Tkw_BaseTextOperations_Control_Text

// start class Tkw_BaseTextOperations_Control_Text

{$If not defined(NoScripts)}
function Tkw_BaseTextOperations_Control_Text.GetString: AnsiString;
 {-}
begin
 Result := 'Text';
end;//Tkw_BaseTextOperations_Control_Text.GetString
{$IfEnd} //not NoScripts

type
  Tkw_BaseTextOperations_Control_Text_Push = class(TkwBynameControlPush)
...
[code] }
  ...
  // overridden protected methods
   ...
   procedure DoDoIt(const aCtx: TtfwContext); override;
    {$IfEnd} //not NoScripts
  end;//Tkw_BaseTextOperations_Control_Text_Push

// start class Tkw_BaseTextOperations_Control_Text_Push

{$If not defined(NoScripts)}
procedure Tkw_BaseTextOperations_Control_Text_Push.DoDoIt(const aCtx: TtfwContext);
 {-}
begin
 aCtx.rEngine.PushString('Text');
 inherited;
end;//Tkw_BaseTextOperations_Control_Text_Push.DoDoIt
{$IfEnd} //not NoScripts

type
  Tkw_BaseTextOperations_Component_TextSource = class(TtfwControlString)
...
[code] }
  ...
  // overridden protected methods
   ...
   function GetString: AnsiString; override;
    {$IfEnd} //not NoScripts
  end;//Tkw_BaseTextOperations_Component_TextSource

// start class Tkw_BaseTextOperations_Component_TextSource

{$If not defined(NoScripts)}
function Tkw_BaseTextOperations_Component_TextSource.GetString: AnsiString;
 {-}
begin
 Result := 'TextSource';
end;//Tkw_BaseTextOperations_Component_TextSource.GetString
{$IfEnd} //not NoScripts
...
//#UC START# *4A1FF17502AC_4AE1A69E0156_impl*
 ...
 begin
  with dmStdRes do
  begin
   SaveDialog.FileName := l3PStr(CreateFileName(DocumentForExport, aExportSelection));
 ...
 begin
  l_Output := TnsGetGenOutputStruct_Create(nsMakeTemporaryFileName(
   CreateFileName(DocumentForExport, aExportSelection), '.rtf'));
  l_Format := CF_RTF;
  l_F := ns_ffRTF;
 end;//aNeedDialog
 try
...
//#UC START# *4DCD5DE203C5_4AE1A69E0156_impl*
 Tf1MultylinkResolver.SetTo(theGen, DocumentForExport);
...
{$Else  BaseTextOperations_imp_impl}
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_BaseTextOperations_Control_Text
 Tkw_BaseTextOperations_Control_Text.Register('контрол::Text', TnscEditor);
// Регистрация Tkw_BaseTextOperations_Control_Text_Push
 Tkw_BaseTextOperations_Control_Text_Push.Register('контрол::Text:push');
// Регистрация Tkw_BaseTextOperations_Component_TextSource
 Tkw_BaseTextOperations_Component_TextSource.Register('компонент::TextSource', TnscTextSource);
{$IfEnd} //not Admin AND not Monitorings
