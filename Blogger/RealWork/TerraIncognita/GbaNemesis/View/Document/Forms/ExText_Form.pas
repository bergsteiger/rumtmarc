...
//#UC START# *4EBAB40900C2_49539DBA029D_impl*
 ...
 begin
  case UserType of
   ...
   begin
    // КОСТЫЛЬ. Задача на рефакторинг написана: К380043923
    CCaption := GetDocumentName(l_Document);
   ...
   dftDrug:
    CCaption := l3Cat(CurUserType.Caption + ' : ', GetDocumentName(l_Document));
     // - хотели именно полное имя (CQ: OIT5-29237);
  end;//case UserType
  LoadFromSettings;
  ContextChanged(nil);
  CheckLinkedWindows;
...
(* Этот вариант - не прошел. Сравнение шло всегда с актуальной редакцией.
