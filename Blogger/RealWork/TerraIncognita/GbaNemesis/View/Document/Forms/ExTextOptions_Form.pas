...
initialization
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_ExTextOptions_Control_WarnPreActive
 Tkw_ExTextOptions_Control_WarnPreActive.Register('контрол::WarnPreActive', TnscReminder);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_ExTextOptions_Control_WarnPreActive_Push
 Tkw_ExTextOptions_Control_WarnPreActive_Push.Register('контрол::WarnPreActive:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_ExTextOptions_Control_WarnRedaction
 Tkw_ExTextOptions_Control_WarnRedaction.Register('контрол::WarnRedaction', TnscReminder);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_ExTextOptions_Control_WarnRedaction_Push
 Tkw_ExTextOptions_Control_WarnRedaction_Push.Register('контрол::WarnRedaction:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_ExTextOptions_Control_WarnTimeMachineException
 Tkw_ExTextOptions_Control_WarnTimeMachineException.Register('контрол::WarnTimeMachineException', TnscReminder);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_ExTextOptions_Control_WarnTimeMachineException_Push
 Tkw_ExTextOptions_Control_WarnTimeMachineException_Push.Register('контрол::WarnTimeMachineException:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_ExTextOptions_Control_WarnIsAbolished
 Tkw_ExTextOptions_Control_WarnIsAbolished.Register('контрол::WarnIsAbolished', TnscReminder);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_ExTextOptions_Control_WarnIsAbolished_Push
 Tkw_ExTextOptions_Control_WarnIsAbolished_Push.Register('контрол::WarnIsAbolished:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_ExTextOptions_Control_WarnJuror
 Tkw_ExTextOptions_Control_WarnJuror.Register('контрол::WarnJuror', TnscReminder);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_ExTextOptions_Control_WarnJuror_Push
 Tkw_ExTextOptions_Control_WarnJuror_Push.Register('контрол::WarnJuror:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_ExTextOptions_Control_WarnOnControl
 Tkw_ExTextOptions_Control_WarnOnControl.Register('контрол::WarnOnControl', TnscReminder);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_ExTextOptions_Control_WarnOnControl_Push
 Tkw_ExTextOptions_Control_WarnOnControl_Push.Register('контрол::WarnOnControl:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_ExTextOptions_Control_WarnTimeMachineOn
 Tkw_ExTextOptions_Control_WarnTimeMachineOn.Register('контрол::WarnTimeMachineOn', TnscReminder);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_ExTextOptions_Control_WarnTimeMachineOn_Push
 Tkw_ExTextOptions_Control_WarnTimeMachineOn_Push.Register('контрол::WarnTimeMachineOn:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_ExTextOptions_Control_WarnTimeMachineWarning
 Tkw_ExTextOptions_Control_WarnTimeMachineWarning.Register('контрол::WarnTimeMachineWarning', TnscReminder);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_ExTextOptions_Control_WarnTimeMachineWarning_Push
 Tkw_ExTextOptions_Control_WarnTimeMachineWarning_Push.Register('контрол::WarnTimeMachineWarning:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_ExTextOptions_Control_WarnInactualDocument
 Tkw_ExTextOptions_Control_WarnInactualDocument.Register('контрол::WarnInactualDocument', TnscReminder);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_ExTextOptions_Control_WarnInactualDocument_Push
 Tkw_ExTextOptions_Control_WarnInactualDocument_Push.Register('контрол::WarnInactualDocument:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_ExTextOptions_Component_RemindersLine
 Tkw_ExTextOptions_Component_RemindersLine.Register('компонент::RemindersLine', TnscRemindersLine);
{$IfEnd} //not Admin AND not Monitorings
