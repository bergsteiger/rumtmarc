...
// Регистрация Tkw_PrimAttributeSelect_Control_BackgroundPanel
 Tkw_PrimAttributeSelect_Control_BackgroundPanel.Register('контрол::BackgroundPanel', TvtProportionalPanel);
// Регистрация Tkw_PrimAttributeSelect_Control_BackgroundPanel_Push
 Tkw_PrimAttributeSelect_Control_BackgroundPanel_Push.Register('контрол::BackgroundPanel:push');
// Регистрация Tkw_PrimAttributeSelect_Control_SelectedZone
 Tkw_PrimAttributeSelect_Control_SelectedZone.Register('контрол::SelectedZone', TvtSizeablePanel);
// Регистрация Tkw_PrimAttributeSelect_Control_SelectedZone_Push
 Tkw_PrimAttributeSelect_Control_SelectedZone_Push.Register('контрол::SelectedZone:push');
// Регистрация Tkw_PrimAttributeSelect_Control_ValuesZone
 Tkw_PrimAttributeSelect_Control_ValuesZone.Register('контрол::ValuesZone', TvtPanel);
// Регистрация Tkw_PrimAttributeSelect_Control_ValuesZone_Push
 Tkw_PrimAttributeSelect_Control_ValuesZone_Push.Register('контрол::ValuesZone:push');
