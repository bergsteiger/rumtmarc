...
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimDiction_Control_BackgroundPanel
 Tkw_PrimDiction_Control_BackgroundPanel.Register('контрол::BackgroundPanel', TvtPanel);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimDiction_Control_BackgroundPanel_Push
 Tkw_PrimDiction_Control_BackgroundPanel_Push.Register('контрол::BackgroundPanel:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimDiction_Control_ContextFilter
 Tkw_PrimDiction_Control_ContextFilter.Register('контрол::ContextFilter', TnscContextFilter);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimDiction_Control_ContextFilter_Push
 Tkw_PrimDiction_Control_ContextFilter_Push.Register('контрол::ContextFilter:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimDiction_Control_WordsTree
 Tkw_PrimDiction_Control_WordsTree.Register('контрол::WordsTree', TnscTreeView);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimDiction_Control_WordsTree_Push
 Tkw_PrimDiction_Control_WordsTree_Push.Register('контрол::WordsTree:push');
{$IfEnd} //not Admin AND not Monitorings
