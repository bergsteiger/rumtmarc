...
type
  Tkw_PrimContactList_Control_BackgroundPanel = class(TtfwControlString)
...
[code] }
  ...
  // overridden protected methods
   ...
   function GetString: AnsiString; override;
    {$IfEnd} //not NoScripts
  end;//Tkw_PrimContactList_Control_BackgroundPanel

// start class Tkw_PrimContactList_Control_BackgroundPanel

{$If not defined(NoScripts)}
function Tkw_PrimContactList_Control_BackgroundPanel.GetString: AnsiString;
 {-}
begin
 Result := 'BackgroundPanel';
end;//Tkw_PrimContactList_Control_BackgroundPanel.GetString
{$IfEnd} //not NoScripts

type
  Tkw_PrimContactList_Control_BackgroundPanel_Push = class(TkwBynameControlPush)
...
[code] }
  ...
  // overridden protected methods
   ...
   procedure DoDoIt(const aCtx: TtfwContext); override;
    {$IfEnd} //not NoScripts
  end;//Tkw_PrimContactList_Control_BackgroundPanel_Push

// start class Tkw_PrimContactList_Control_BackgroundPanel_Push

{$If not defined(NoScripts)}
procedure Tkw_PrimContactList_Control_BackgroundPanel_Push.DoDoIt(const aCtx: TtfwContext);
 {-}
begin
 aCtx.rEngine.PushString('BackgroundPanel');
 inherited;
end;//Tkw_PrimContactList_Control_BackgroundPanel_Push.DoDoIt
{$IfEnd} //not NoScripts

type
  Tkw_PrimContactList_Control_ContextFilter = class(TtfwControlString)
...
[code] }
  ...
  // overridden protected methods
   ...
   function GetString: AnsiString; override;
    {$IfEnd} //not NoScripts
  end;//Tkw_PrimContactList_Control_ContextFilter

// start class Tkw_PrimContactList_Control_ContextFilter

{$If not defined(NoScripts)}
function Tkw_PrimContactList_Control_ContextFilter.GetString: AnsiString;
 {-}
begin
 Result := 'ContextFilter';
end;//Tkw_PrimContactList_Control_ContextFilter.GetString
{$IfEnd} //not NoScripts

type
  Tkw_PrimContactList_Control_ContextFilter_Push = class(TkwBynameControlPush)
...
[code] }
  ...
  // overridden protected methods
   ...
   procedure DoDoIt(const aCtx: TtfwContext); override;
    {$IfEnd} //not NoScripts
  end;//Tkw_PrimContactList_Control_ContextFilter_Push

// start class Tkw_PrimContactList_Control_ContextFilter_Push

{$If not defined(NoScripts)}
procedure Tkw_PrimContactList_Control_ContextFilter_Push.DoDoIt(const aCtx: TtfwContext);
 {-}
begin
 aCtx.rEngine.PushString('ContextFilter');
 inherited;
end;//Tkw_PrimContactList_Control_ContextFilter_Push.DoDoIt
{$IfEnd} //not NoScripts

type
  Tkw_PrimContactList_Control_trContactList = class(TtfwControlString)
...
[code] }
  ...
  // overridden protected methods
   ...
   function GetString: AnsiString; override;
    {$IfEnd} //not NoScripts
  end;//Tkw_PrimContactList_Control_trContactList

// start class Tkw_PrimContactList_Control_trContactList

{$If not defined(NoScripts)}
function Tkw_PrimContactList_Control_trContactList.GetString: AnsiString;
 {-}
begin
 Result := 'trContactList';
end;//Tkw_PrimContactList_Control_trContactList.GetString
{$IfEnd} //not NoScripts

type
  Tkw_PrimContactList_Control_trContactList_Push = class(TkwBynameControlPush)
...
[code] }
  ...
  // overridden protected methods
   ...
   procedure DoDoIt(const aCtx: TtfwContext); override;
    {$IfEnd} //not NoScripts
  end;//Tkw_PrimContactList_Control_trContactList_Push

// start class Tkw_PrimContactList_Control_trContactList_Push

{$If not defined(NoScripts)}
procedure Tkw_PrimContactList_Control_trContactList_Push.DoDoIt(const aCtx: TtfwContext);
 {-}
begin
 aCtx.rEngine.PushString('trContactList');
 inherited;
end;//Tkw_PrimContactList_Control_trContactList_Push.DoDoIt
{$IfEnd} //not NoScripts
...
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimContactList_Control_BackgroundPanel
 Tkw_PrimContactList_Control_BackgroundPanel.Register('контрол::BackgroundPanel', TvtPanel);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimContactList_Control_BackgroundPanel_Push
 Tkw_PrimContactList_Control_BackgroundPanel_Push.Register('контрол::BackgroundPanel:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimContactList_Control_ContextFilter
 Tkw_PrimContactList_Control_ContextFilter.Register('контрол::ContextFilter', TnscContextFilter);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimContactList_Control_ContextFilter_Push
 Tkw_PrimContactList_Control_ContextFilter_Push.Register('контрол::ContextFilter:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimContactList_Control_trContactList
 Tkw_PrimContactList_Control_trContactList.Register('контрол::trContactList', TeeTreeView);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimContactList_Control_trContactList_Push
 Tkw_PrimContactList_Control_trContactList_Push.Register('контрол::trContactList:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
