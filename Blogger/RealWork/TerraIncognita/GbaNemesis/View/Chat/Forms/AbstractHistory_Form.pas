...
type
 ...
 TvcmContainerFormRef = TAbstractHistoryForm;
{$IfEnd} //not Admin AND not Monitorings
...
type
  Tkw_AbstractHistory_Control_HistoryEditor = class(TtfwControlString)
...
[code] }
  ...
  // overridden protected methods
   ...
   function GetString: AnsiString; override;
    {$IfEnd} //not NoScripts
  end;//Tkw_AbstractHistory_Control_HistoryEditor

// start class Tkw_AbstractHistory_Control_HistoryEditor

{$If not defined(NoScripts)}
function Tkw_AbstractHistory_Control_HistoryEditor.GetString: AnsiString;
 {-}
begin
 Result := 'HistoryEditor';
end;//Tkw_AbstractHistory_Control_HistoryEditor.GetString
{$IfEnd} //not NoScripts

type
  Tkw_AbstractHistory_Control_HistoryEditor_Push = class(TkwBynameControlPush)
...
[code] }
  ...
  // overridden protected methods
   ...
   procedure DoDoIt(const aCtx: TtfwContext); override;
    {$IfEnd} //not NoScripts
  end;//Tkw_AbstractHistory_Control_HistoryEditor_Push

// start class Tkw_AbstractHistory_Control_HistoryEditor_Push

{$If not defined(NoScripts)}
procedure Tkw_AbstractHistory_Control_HistoryEditor_Push.DoDoIt(const aCtx: TtfwContext);
 {-}
begin
 aCtx.rEngine.PushString('HistoryEditor');
 inherited;
end;//Tkw_AbstractHistory_Control_HistoryEditor_Push.DoDoIt
{$IfEnd} //not NoScripts
...
initialization
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_AbstractHistory_Control_HistoryEditor
 Tkw_AbstractHistory_Control_HistoryEditor.Register('контрол::HistoryEditor', TnscChatMemo);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_AbstractHistory_Control_HistoryEditor_Push
 Tkw_AbstractHistory_Control_HistoryEditor_Push.Register('контрол::HistoryEditor:push');
{$IfEnd} //not Admin AND not Monitorings
