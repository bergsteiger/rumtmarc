...
type
  Tkw_PrimPictureOptions_Component_ieProc = class(TtfwControlString)
   {* Слово словаря для идентификатора компонента ieProc
----
...
initialization
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimPictureOptions_Component_ieProc
 Tkw_PrimPictureOptions_Component_ieProc.Register('компонент::ieProc', TImageEnProc);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimPictureOptions_Control_ieViewer
 Tkw_PrimPictureOptions_Control_ieViewer.Register('контрол::ieViewer', TImageEnView);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimPictureOptions_Control_ieViewer_Push
 Tkw_PrimPictureOptions_Control_ieViewer_Push.Register('контрол::ieViewer:push');
{$IfEnd} //not Admin AND not Monitorings
