...
(* System = operations
  {* Система }
   ['{E5948836-1B00-4F26-8CAE-BF97BCEA832A}']
   query CommonDataChanged;
 end;//System*)
...
type
 Op_System_CommonDataChanged = class
  {* Класс для вызова операции System.CommonDataChanged }
 public
 // public methods
   class function Call(const aTarget: IvcmEntity): Boolean; overload; 
     {* Вызов операции System.CommonDataChanged у сущности }
   class function Call(const aTarget: IvcmAggregate): Boolean; overload; 
     {* Вызов операции System.CommonDataChanged у агрегации }
   class function Call(const aTarget: IvcmEntityForm): Boolean; overload; 
     {* Вызов операции System.CommonDataChanged у формы }
   class function Call(const aTarget: IvcmContainer): Boolean; overload; 
     {* Вызов операции System.CommonDataChanged у контейнера }
   class procedure Broadcast;
     {* Вызов операции System.CommonDataChanged у всех зарегистрированных сущностей }
 end;//Op_System_CommonDataChanged
...
const
 ...
 op_CommonDataChanged = 'CommonDataChanged';
...
// start class Op_System_CommonDataChanged

class function Op_System_CommonDataChanged.Call(const aTarget: IvcmEntity): Boolean;
var
...
begin
 ...
 begin
  l_Params := vcmParams;
  aTarget.Operation(TdmStdRes.opcode_System_CommonDataChanged, l_Params);
  with l_Params do
  begin
   if Done then
   begin
...
end;//Op_System_CommonDataChanged.Call

class function Op_System_CommonDataChanged.Call(const aTarget: IvcmAggregate): Boolean;
var
 l_Params : IvcmExecuteParams;
begin
 l3FillChar(Result, SizeOf(Result));
...
class function Op_System_CommonDataChanged.Call(const aTarget: IvcmEntityForm): Boolean;
 {-}
begin
 l3FillChar(Result, SizeOf(Result));
 if (aTarget <> nil) then
...
class function Op_System_CommonDataChanged.Call(const aTarget: IvcmContainer): Boolean;
 {-}
begin
 l3FillChar(Result, SizeOf(Result));
 if (aTarget <> nil) then
...
class procedure Op_System_CommonDataChanged.Broadcast;
var
 l_Params : IvcmExecuteParams;
begin
 ...
 begin
  l_Params := vcmParams;
  vcmDispatcher.EntityOperationBroadcast(TdmStdRes.opcode_System_CommonDataChanged, l_Params);
 end;//vcmDispatcher <> nil
end;//Op_System_CommonDataChanged.Broadcast
