...
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimConfigurationList_Control_tvConfs
 Tkw_PrimConfigurationList_Control_tvConfs.Register('контрол::tvConfs', TnscTreeView);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimConfigurationList_Control_tvConfs_Push
 Tkw_PrimConfigurationList_Control_tvConfs_Push.Register('контрол::tvConfs:push');
{$IfEnd} //not Admin AND not Monitorings
