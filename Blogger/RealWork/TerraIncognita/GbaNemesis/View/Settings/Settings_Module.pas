...
type
  Tkw_StyleEditorNavigator_f_StyleTreeView_ControlInstance = class(TtfwWord)
   {* Слово словаря для доступа к экземпляру контрола f_StyleTreeView формы StyleEditorNavigator }
  protected
  // realized methods
    {$If not defined(NoScripts)}
...
type
  Tkw_StyleEditorExample_f_TextSource_ControlInstance = class(TtfwWord)
   {* Слово словаря для доступа к экземпляру контрола f_TextSource формы StyleEditorExample }
  protected
  // realized methods
    {$If not defined(NoScripts)}
   procedure DoDoIt(const aCtx: TtfwContext); override;
...
// Регистрация Tkw_Form_StyleEditorContainer
 Tkw_Form_StyleEditorContainer.Register('форма::StyleEditorContainer', TStyleEditorContainerForm);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_Form_StyleEditorFont
 Tkw_Form_StyleEditorFont.Register('форма::StyleEditorFont', TStyleEditorFontForm);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_Form_StyleEditorNavigator
 Tkw_Form_StyleEditorNavigator.Register('форма::StyleEditorNavigator', TStyleEditorNavigatorForm);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_StyleEditorNavigator_f_StyleTreeView_ControlInstance
...
// Регистрация Tkw_Form_Settings
 Tkw_Form_Settings.Register('форма::Settings', Tcf_Settings);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_Form_StyleEditorExample
 Tkw_Form_StyleEditorExample.Register('форма::StyleEditorExample', TStyleEditorExampleForm);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_StyleEditorExample_f_TextSource_ControlInstance
...
// Регистрация Tkw_Form_SelfInfo
 Tkw_Form_SelfInfo.Register('форма::SelfInfo', TSelfInfoForm);
{$IfEnd} //not Admin AND not Monitorings
