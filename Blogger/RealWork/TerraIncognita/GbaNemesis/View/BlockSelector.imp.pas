...
//#UC START# *4C06874C0070_4C0686B8005B_var*
 ...
 begin
  ...
  begin
   ...
   while (l_P <> nil) do
   begin
    if l_P.Obj.InheritsFrom(k2_idBlock) then
     if (l_P.Obj.IntA[k2_tiHandle] = aBlock.ID) AND
        (l_P.Obj.IntA[k2_tiLayerID] = aBlock.LayerID) then
     begin
      Result := true;
      Exit;
   ...
   begin
    ...
    begin
     ...
     if (l_Total > 1000) then
      Exit;
     if l_Para.InheritsFrom(k2_idBlock) AND
        (l_Para.IntA[k2_tiLayerID] = ev_sbtSub) then
     begin
      l_ID := l_Para.IntA[k2_tiHandle];
     ...
     end;//l_Para.InheritsFrom(k2_idBlock)
     l_Para := l_Para.Prev;
    ...
    begin
     ...
     if (l_Parent = nil) OR not l_Parent.Para.IsValid then
      Exit;
     if l_Parent.Para.InheritsFrom(k2_idDocument) then
      Exit; 
