...
// Generated from UML model, root element: <<SimpleClass::Class>> F1 Core::Common::View::Common::Tkw_Common_LetterToDevelopers
//
...
type
 ...
 Tkw_Common_LetterToDevelopers = class(_tfwModuleOperationWord_)
  {* Слово словаря для вызова операции модуля Common.LetterToDevelopers (Окна Письмо разработчикам) }
 protected
...
type _Instance_R_ = Tkw_Common_LetterToDevelopers;
