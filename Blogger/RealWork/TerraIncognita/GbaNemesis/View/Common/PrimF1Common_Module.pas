...
type
  Tkw_Navigator_NavigatorTree_ControlInstance = class(TtfwWord)
   {* Слово словаря для доступа к экземпляру контрола NavigatorTree формы Navigator }
  protected
  // realized methods
    {$If not defined(NoScripts)}
...
type
  Tkw_TurnOffTimeMachine_rb_totmChangeDate_ControlInstance = class(TtfwWord)
   {* Слово словаря для доступа к экземпляру контрола rb_totmChangeDate формы TurnOffTimeMachine }
  protected
  // realized methods
    {$If not defined(NoScripts)}
   procedure DoDoIt(const aCtx: TtfwContext); override;
...
type
  Tkw_TurnOffTimeMachine_rb_totmStayInCurrentRedaction_ControlInstance = class(TtfwWord)
   {* Слово словаря для доступа к экземпляру контрола rb_totmStayInCurrentRedaction формы TurnOffTimeMachine }
  protected
  // realized methods
    {$If not defined(NoScripts)}
   procedure DoDoIt(const aCtx: TtfwContext); override;
...
type
  Tkw_TurnOffTimeMachine_rb_totmGotoActualRedaction_ControlInstance = class(TtfwWord)
   {* Слово словаря для доступа к экземпляру контрола rb_totmGotoActualRedaction формы TurnOffTimeMachine }
  protected
  // realized methods
    {$If not defined(NoScripts)}
   procedure DoDoIt(const aCtx: TtfwContext); override;
...
type
  Tkw_TurnOffTimeMachine_deChangeDate_ControlInstance = class(TtfwWord)
   {* Слово словаря для доступа к экземпляру контрола deChangeDate формы TurnOffTimeMachine }
  protected
  // realized methods
    {$If not defined(NoScripts)}
   procedure DoDoIt(const aCtx: TtfwContext); override;
...
// Регистрация Tkw_Form_RememberPassword
 Tkw_Form_RememberPassword.Register('форма::RememberPassword', TRememberPasswordForm);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_Form_RegistrationForm
 Tkw_Form_RegistrationForm.Register('форма::RegistrationForm', TnsRegistrationForm);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
...
// Регистрация Tkw_Form_Navigator
 Tkw_Form_Navigator.Register('форма::Navigator', Ten_Navigator);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_Navigator_NavigatorTree_ControlInstance
...
// Регистрация Tkw_Form_TurnOffTimeMachine
 Tkw_Form_TurnOffTimeMachine.Register('форма::TurnOffTimeMachine', Ten_TurnOffTimeMachine);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_TurnOffTimeMachine_rb_totmChangeDate_ControlInstance
...
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_TurnOffTimeMachine_rb_totmStayInCurrentRedaction_ControlInstance
...
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_TurnOffTimeMachine_rb_totmGotoActualRedaction_ControlInstance
...
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_TurnOffTimeMachine_deChangeDate_ControlInstance
