...
// Библиотека "View"
// Автор: Люлин А.В.
// Модуль: "w:/garant6x/implementation/Garant/GbaNemesis/View/Common/Forms/PrimCommonDiction_utTips_UserType.pas"
...
// Регистрация Tkw_FormUserType_utTips
 Tkw_FormUserType_utTips.Register('тип_формы::utTips');
{$IfEnd} //not Admin AND not Monitorings
