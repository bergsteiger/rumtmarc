...
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimContents_Control_BackgroundPanel
 Tkw_PrimContents_Control_BackgroundPanel.Register('контрол::BackgroundPanel', TvtPanel);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimContents_Control_BackgroundPanel_Push
 Tkw_PrimContents_Control_BackgroundPanel_Push.Register('контрол::BackgroundPanel:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimContents_Control_lstBookmarks
 Tkw_PrimContents_Control_lstBookmarks.Register('контрол::lstBookmarks', TvtLister);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimContents_Control_lstBookmarks_Push
 Tkw_PrimContents_Control_lstBookmarks_Push.Register('контрол::lstBookmarks:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimContents_Control_lstComments
 Tkw_PrimContents_Control_lstComments.Register('контрол::lstComments', TvtLister);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimContents_Control_lstComments_Push
 Tkw_PrimContents_Control_lstComments_Push.Register('контрол::lstComments:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimContents_Control_lstExternalObjects
 Tkw_PrimContents_Control_lstExternalObjects.Register('контрол::lstExternalObjects', TvtLister);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimContents_Control_lstExternalObjects_Push
 Tkw_PrimContents_Control_lstExternalObjects_Push.Register('контрол::lstExternalObjects:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimContents_Control_ContentsTree
 Tkw_PrimContents_Control_ContentsTree.Register('контрол::ContentsTree', TnscTreeView);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimContents_Control_ContentsTree_Push
 Tkw_PrimContents_Control_ContentsTree_Push.Register('контрол::ContentsTree:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimContents_Control_ContextFilter
 Tkw_PrimContents_Control_ContextFilter.Register('контрол::ContextFilter', TnscContextFilter);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimContents_Control_ContextFilter_Push
 Tkw_PrimContents_Control_ContextFilter_Push.Register('контрол::ContextFilter:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimContents_Control_Tasks
 Tkw_PrimContents_Control_Tasks.Register('контрол::Tasks', TnscTasksPanelView);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimContents_Control_Tasks_Push
 Tkw_PrimContents_Control_Tasks_Push.Register('контрол::Tasks:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
