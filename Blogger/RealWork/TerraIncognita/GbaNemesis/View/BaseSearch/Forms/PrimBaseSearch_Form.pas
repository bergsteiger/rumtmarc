...
type
  Tkw_PrimBaseSearch_Component_FlashTimer = class(TtfwControlString)
   {* Слово словаря для идентификатора компонента FlashTimer
----
*Пример использования*:
[code]
...
initialization
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimBaseSearch_Control_ContextEdit
 Tkw_PrimBaseSearch_Control_ContextEdit.Register('контрол::ContextEdit', TnscTreeComboWithHistoryAndOperations);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimBaseSearch_Control_ContextEdit_Push
 Tkw_PrimBaseSearch_Control_ContextEdit_Push.Register('контрол::ContextEdit:push');
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Регистрация Tkw_PrimBaseSearch_Component_FlashTimer
 Tkw_PrimBaseSearch_Component_FlashTimer.Register('компонент::FlashTimer', TTimer);
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
