...
type
 ...
 protected
 // realized methods
   function CheckAtom(aProp: Tk2CustomProperty): InevTag;
   function MakeSubTag(const aProvider: If1TagDataProvider): InevTag;
...
function Tf1AtomChecker.CheckAtom(aProp: Tk2CustomProperty): InevTag;
...
function Tf1AtomChecker.MakeSubTag(const aProvider: If1TagDataProvider): InevTag;
...
function Tf1AtomChecker.Get_Tag: InevTag;
