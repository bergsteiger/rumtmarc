...
type
 ...
 // overridden protected methods
   class procedure ForceStore(const aTag: Ik2Tag); override;
 protected
 // protected methods
...
class procedure TnsCommentStorer.ForceStore(const aTag: Ik2Tag);
...
//#UC START# *4CED30D901C7_4CED328E0140_impl*
 inherited;
 if Supports(aTag, If1CommentSink, l_Sink) then
  try
