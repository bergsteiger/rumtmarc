...
// Контейнер всех системных строковых констант во ВСЕМ пректе
// DO NOT LOCALIZE :)  
...
const
// Unit - nsAppConfig
  { НАВИГАТОР : + "vcm_ztNavigator/ZoneSetting"; (fLeftNavigator, fRightNavigator);
    ПЛАВАЮЩИЙ:  + "/FloatingSetting" (False, True); }
...
// Unit - nsUtils
  // function - nsConvertAnnoKind // ЖОПА! Есть ощущние, что часть из этих констант
                                  // живет на адаптере, а у нас дублируется!
