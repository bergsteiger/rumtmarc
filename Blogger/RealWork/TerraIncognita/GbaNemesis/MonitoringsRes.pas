...
class function TMonitoringsRes.OpenPostingOrder(const aQuery: IQuery): IvcmEntityForm;
begin
...
class function TMonitoringsRes.StartOpen(const aContainer: IvcmContainer): IvcmEntityForm;
begin
