...
//
// Библиотека "Data"
// Модуль: "w:/garant6x/implementation/Garant/GbaNemesis/Data/nsCounterEvent.pas"
// Родные Delphi интерфейсы (.pas)
// Generated from UML model, root element: <<SimpleClass::Class>> F1 Базовые определения предметной области::LegalDomain::Data::Logging::TnsCounterEvent
//
//
...
type
 TnsCounterEvent = class(TnsPrimCachedEvent)
 private
 // private fields
   f_Counter : Cardinal;
 protected
