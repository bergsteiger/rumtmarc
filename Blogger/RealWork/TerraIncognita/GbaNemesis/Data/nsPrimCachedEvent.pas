...
//
// Библиотека "Data"
// Модуль: "w:/garant6x/implementation/Garant/GbaNemesis/Data/nsPrimCachedEvent.pas"
// Родные Delphi интерфейсы (.pas)
// Generated from UML model, root element: <<SimpleClass::Class>> F1 Базовые определения предметной области::LegalDomain::Data::Logging::TnsPrimCachedEvent
//
//
...
type
 TnsPrimCachedEvent = class(TnsLogEvent, InsDefferedEvent)
 protected
 // realized methods
   procedure FireLog;
 protected
