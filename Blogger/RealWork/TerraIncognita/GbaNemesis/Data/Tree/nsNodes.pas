...
// $Id: nsNodes.pas,v 1.12 2012/04/16 14:16:02 lulin Exp $
...
function TnsCacheableNode.pm_GetIndexInParent: Integer;
begin
...
procedure TnsCacheableNode.IncAllChildrenCount(aInc: Integer);
begin
 if aInc <> 0 then
  f_ThisChildrenCount := -1;
 inherited IncAllChildrenCount(aInc);
end;
...
function TnsCacheableNode.GetThisChildrenCount: Integer;
...
procedure TnsCacheableNode.DoRemove;
var
...
function TnsCacheableNode.InsertChildBefore(const aNextChild : Il3Node;
                                            const aChild : Il3Node) : Il3Node;
var
 lPrevNode,
 lNextNode  : Il3Node;
