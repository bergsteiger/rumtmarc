...
// $Id: nsConst.pas,v 1.36 2013/08/23 12:58:45 lulin Exp $
...
(*   {$If not defined(Admin) AND not defined(Monitorings)}
  ...
  gi_Document = 'Работа с документом';
   ...
   pi_Document_ShowSpatial = gi_Document + '/Спецсимволы';
    dv_Document_ShowSpatial = False;
  ...
  gi_MyDocuments = 'Работа с ''Моими документами''';
   pi_OpenInNewWindow = gi_MyDocuments + '/Открывать в новом окне';
    dv_OpenInNewWindow = False;
