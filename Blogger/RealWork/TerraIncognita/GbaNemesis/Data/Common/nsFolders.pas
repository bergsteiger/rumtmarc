...
// $Id: nsFolders.pas,v 1.17 2013/05/13 17:23:41 lulin Exp $
...
// - new: operation OpenControllableElement
//
...
type
 ...
 {$If not (defined(Monitorings) or defined(Admin))}
  ...
  public
  // public methods
    constructor Create(acbShare: TeeCheckBox);
      reintroduce;
      {-}
    procedure Clear; 
      {-}
...
constructor TFolderSecurity.Create(acbShare: TeeCheckBox);
begin
 inherited Create;
 f_cbShared := acbShare;
