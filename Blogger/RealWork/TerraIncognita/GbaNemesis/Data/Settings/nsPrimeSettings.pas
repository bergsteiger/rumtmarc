...
{$If defined(nsWithoutLogin)}
type
 TnsPrimeSettings = class(TnsSettingsPrim, IafwSettings, IafwSettingsNotify, InsSettingsNotify, InsSettings)
 private
 // private fields
...
function TnsPrimeSettings.Clone(const aConf: IUnknown): IafwSettings;
//#UC START# *473D9F0F033A_4C99AEBC01B3_var*
//#UC END# *473D9F0F033A_4C99AEBC01B3_var*
begin
//#UC START# *473D9F0F033A_4C99AEBC01B3_impl*
 Result := Self;
//#UC END# *473D9F0F033A_4C99AEBC01B3_impl*
end;//TnsPrimeSettings.Clone

procedure TnsPrimeSettings.AddListener(const aListener: IafwSettingListener);
//#UC START# *475E8E410197_4C99AEBC01B3_var*
//#UC END# *475E8E410197_4C99AEBC01B3_var*
begin
//#UC START# *475E8E410197_4C99AEBC01B3_impl*
// Do nothing
//#UC END# *475E8E410197_4C99AEBC01B3_impl*
end;//TnsPrimeSettings.AddListener

procedure TnsPrimeSettings.RemoveListener(const aListener: IafwSettingListener);
//#UC START# *475E8E4D03E4_4C99AEBC01B3_var*
//#UC END# *475E8E4D03E4_4C99AEBC01B3_var*
begin
//#UC START# *475E8E4D03E4_4C99AEBC01B3_impl*
// Do nothing
//#UC END# *475E8E4D03E4_4C99AEBC01B3_impl*
end;//TnsPrimeSettings.RemoveListener

procedure TnsPrimeSettings.AddListener(const aListener: IafwSettingsReplaceListener);
//#UC START# *475E8E5E0286_4C99AEBC01B3_var*
//#UC END# *475E8E5E0286_4C99AEBC01B3_var*
begin
//#UC START# *475E8E5E0286_4C99AEBC01B3_impl*
// Do nothing
//#UC END# *475E8E5E0286_4C99AEBC01B3_impl*
end;//TnsPrimeSettings.AddListener

procedure TnsPrimeSettings.RemoveListener(const aListener: IafwSettingsReplaceListener);
//#UC START# *475E8E7900A3_4C99AEBC01B3_var*
//#UC END# *475E8E7900A3_4C99AEBC01B3_var*
begin
//#UC START# *475E8E7900A3_4C99AEBC01B3_impl*
// Do nothing
//#UC END# *475E8E7900A3_4C99AEBC01B3_impl*
end;//TnsPrimeSettings.RemoveListener

function TnsPrimeSettings.pm_GetNotify: IafwSettingsNotify;
//#UC START# *475E8F5A0198_4C99AEBC01B3get_var*
//#UC END# *475E8F5A0198_4C99AEBC01B3get_var*
begin
//#UC START# *475E8F5A0198_4C99AEBC01B3get_impl*
 Result := Self;
//#UC END# *475E8F5A0198_4C99AEBC01B3get_impl*
end;//TnsPrimeSettings.pm_GetNotify
