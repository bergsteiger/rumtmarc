...
type
 ...
 protected
 // protected methods
   function DocumentForFindPara: InevTag; virtual;
...
function TnsF1DocumentContainerPrim.DocumentForFindPara: InevTag;
...
//#UC START# *47F11C2103DC_4C6A7C010114_impl*
 ...
 begin
  Result := false;
  l_Para := nsFindTagByID(DocumentForFindPara, k2_idLeafPara, aParaID);
...
(* if CanFindParaAsNode then*)
  Result := TnsDocumentContainerSub.Make(Document, Processor, anID, aLayerID)
(* else
