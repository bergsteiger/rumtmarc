...
function TnsFiltersRootNode.IsSame(const aNode: Il3SimpleNode): Boolean;
//#UC START# *4ADEE0F60264_5061DE4402FD_var*
var
 l_FilterRootNode: InsFilterRootNode;
//#UC END# *4ADEE0F60264_5061DE4402FD_var*
begin
//#UC START# *4ADEE0F60264_5061DE4402FD_impl*
 Result := False;
 if Supports(aNode, InsFilterRootNode, l_FilterRootNode) then
  Result := l_FilterRootNode.FiltersType = f_FiltersType; 
//#UC END# *4ADEE0F60264_5061DE4402FD_impl*
end;//TnsFiltersRootNode.IsSame
