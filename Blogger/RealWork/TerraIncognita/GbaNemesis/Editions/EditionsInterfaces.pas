...
*)
 ...
 InsVScrollListner = interface(Il3Notify)
...
*)
 ...
 IdsEdition = interface(IvcmViewAreaController{, InsVScrollListner})
   ['{C666C0D5-6FE4-4D49-80A7-685C2E352687}']
  // Методы преобразования к реализуемым интерфейсам
   function As_InsVScrollListner: InsVScrollListner;
 end;//IdsEdition

 IdsEditionDiff = interface(IdsEdition{, InsEditionListner, IucpHAFMacroReplacerFactory, IucpFilterInfoFactory})
