...
{$If not defined(Admin) AND not defined(Monitorings)}
 ...
 _dsEdition_ = {abstract vac} class(_VScroll_, IdsEdition, InsVScrollListner {from IdsEdition})
  {* Базовая область ввода, для работы с редакциями }
 protected
...
//#UC START# *479731C50290_4A71859C0249_impl*
 UseCaseController.As_Il3ChangeNotifier.Unsubscribe(InsVScrollListner(Self));
 inherited;
...
//#UC START# *47A042E100E2_4A71859C0249_impl*
 inherited;
 UseCaseController.As_Il3ChangeNotifier.Subscribe(InsVScrollListner(Self));
...
function _dsEdition_.As_InsVScrollListner: InsVScrollListner;
begin
 Result := Self;
end;
