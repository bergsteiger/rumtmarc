...
var
  ...
  str_wgRedactionHadNotBeenActive : Tl3StringIDEx = (rS : -1; rLocalized : false; rKey : 'wgRedactionHadNotBeenActive'; rValue : 'Редакция не действовала на момент обновления установленной у вас версии системы ГАРАНТ');
   { 'Редакция не действовала на момент обновления установленной у вас версии системы ГАРАНТ' }
...
{$IfEnd} //not Admin AND not Monitorings
{$If not defined(Admin) AND not defined(Monitorings)}
// Инициализация str_wgRedactionHadNotBeenActive
