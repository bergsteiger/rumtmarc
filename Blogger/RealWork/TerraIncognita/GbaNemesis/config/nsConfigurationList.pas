...
// Версия     : $Id: nsConfigurationList.pas,v 1.27 2012/04/17 14:36:45 kostitsin Exp $
...
type
  ...
  private
   ...
   procedure pm_SetActiveConfigSuffix(const aValue: Il3CString);
     {-}
   // public methods
   procedure ActivateConfig(const aConfigNode: InsConfigNode);
     {-}
  ...
  private
   ...
   function FindConfigNode(const aConfig: InsConfigSettingsInfo): IeeNode;
