...
{$If not defined(Admin) AND not defined(Monitorings)}
 ...
 // realized methods
   ...
   function DoGet_dsCRToPart: IdsDocumentList;
...
//#UC START# *493E6F4901E6_493E5C580280_impl*
 Result := False;
 if Assigned(SetData.CRToPartPosList) then
  Result := OpenCRToPart(SetData.CRToPartPosList, aNode, aType);
...
//#UC START# *4937D85C028F_493E5C580280_impl*
 ...
 try
  ...
  if (l_Count <> 0) then
   with SetData do
   begin
    CRToPartFilter := aNode;
    CRToPartList := l_List;
    CRToPartType := aType;
    CRToPartPosList := aPositionList;
   end//with SetData
  else
  begin
   if Assigned(aNode) then
 ...
 with SetData.dsCRToPartRef do
 begin
  Clear;
  NeedMake := vcm_nmForce;
 end;//with SetData.dsCRToPartRef
 Refresh;
 Result := True;
...
function _sdsDocument_.pm_GetDsCRToPart: IdsDocumentList;
//#UC START# *500CED9B0156_493E5C580280get_var*
//#UC END# *500CED9B0156_493E5C580280get_var*
begin
 with pm_GetdsCRToPartRef do
 begin
  if IsEmpty
   //#UC START# *500CED9B0156_493E5C580280get_need*
     AND (NeedMake <> vcm_nmNo)
     AND (SetData.CRToPartType <> crtNone) and Assigned(SetData.CRToPartList)
   // - условие создания ViewArea
  //#UC END# *500CED9B0156_493E5C580280get_need*
   then
    Referred := DoGet_dsCRToPart;
  Result := IdsDocumentList(Referred);
 end;//with pm_GetdsCRToPartRef
end;

function _sdsDocument_.DoGet_dsCRToPart: IdsDocumentList;
...
//#UC START# *500CED9B0156_493E5C580280area_impl*
 Result := TdsDocumentListCRToPart.Make(Self,
                             TdeDocumentListCR.Make(SetData.CRToPartList,
                                            SetData.CRToPartFilter,
                                            SetData.CRToPartType));
//#UC END# *500CED9B0156_493E5C580280area_impl*
end;//_sdsDocument_.DoGet_dsCRToPart

function _sdsDocument_.pm_GetdsCRToPartRef: IvcmViewAreaControllerRef;
begin
 Result := SetData.dsCRToPartRef;
end;
...
//#UC START# *4925B7F00156_493E5C580280_impl*
 ...
 SetData.dsCRToPartRef.Referred := nil;
...
begin
 ...
 pm_GetdsCRToPartRef.Referred := nil;
