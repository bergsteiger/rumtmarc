...
begin
 ...
 Result := vcmMessageDlgPrim(l_Msg, l_Checked, taLeftJustify);
end;
  ...
  begin
   ...
   begin
    ...
    begin
     ...
     DoFileOperation(FO_COPY, l_FileName, l_DestPath, '');
     //
    ...
    for l_Index := 0 to Pred(Count) do
     ...
     begin
      ...
      begin
       Result := True;
       //
       DoFileOperation(FO_COPY, l_FromPath, l_ToPath, '')
      end
      else
