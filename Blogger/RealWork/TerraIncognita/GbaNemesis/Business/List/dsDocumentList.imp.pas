...
{$If not defined(Admin) AND not defined(Monitorings)}
 ...
 // overridden protected methods
   ...
   function DataForNewList(const aNewList: IDynList): IdeList; override;
...
function _dsDocumentList_.DataForNewList(const aNewList: IDynList): IdeList;
...
function _dsDocumentList_.DoApplyLogicOperation(const aList: IUnknown;
