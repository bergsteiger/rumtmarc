...
{ $Id: vcmContainerForm.pas,v 1.101 2013/04/25 14:22:38 lulin Exp $ }
...
// - new method: IvcmContainer._IsNull.
//
 ...
 if HasForm(fm_Any, vcm_ztForFocus, False, @l_CurrEntityForm) then
  try
   ...
   if l_F.CanFocus then
    l_F.SetFocus;
   if (l_F Is TForm) then
   begin
    if (TForm(l_F).ActiveControl <> nil) AND
