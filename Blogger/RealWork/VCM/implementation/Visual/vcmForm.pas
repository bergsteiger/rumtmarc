...
{ $Id: vcmForm.pas,v 1.268 2013/05/21 08:29:20 lulin Exp $ }
...
// - bug fix: не правильно работала операция Get_NativeMainForm, если это свойство спрашивалось у MainForm (результат - Assert)
//
