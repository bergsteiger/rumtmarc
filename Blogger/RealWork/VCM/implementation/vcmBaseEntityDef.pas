...
{ $Id: vcmBaseEntityDef.pas,v 1.14 2013/07/05 09:10:33 lulin Exp $ }
...
type
  TvcmBaseEntityDef = class(TvcmOperationalIdentifiedUserFriendly, IvcmEntityDef)
   {* Базовый класс описания сущности. }
    private
    // internal fields
      f_Entity   : TvcmBaseEntitiesCollectionItem;
    protected
    // inteface methods
      // IvcmEntityDef
    ...
    public
    // public methods
      constructor Create(anEntity: TvcmBaseEntitiesCollectionItem);
        reintroduce;
        {-}
      class function Make(anEntity: TvcmBaseEntitiesCollectionItem): IvcmEntityDef;
        reintroduce;
...
constructor TvcmBaseEntityDef.Create(anEntity: TvcmBaseEntitiesCollectionItem);
  //reintroduce;
  {-}
begin
...
class function TvcmBaseEntityDef.Make(anEntity: TvcmBaseEntitiesCollectionItem): IvcmEntityDef;
  {* - возвращает базовый описатель сущности. }
var
