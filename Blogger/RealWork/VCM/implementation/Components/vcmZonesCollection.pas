...
{ $Id: vcmZonesCollection.pas,v 1.35 2012/12/05 14:49:12 lulin Exp $ }
...
begin
 ...
 for l_Index := 0 to Pred(Count) do
  with TvcmZonesCollectionItem(Items[l_Index]) do
   if (Control <> nil) AND ANSISameText(Control.Name, vcmStr(l_Params.rParent)) AND
      InsertForm(aForm, not l_Params.rFloating) then
   begin
    Result := True;
