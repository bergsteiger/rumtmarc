...
{ $Id: vcmMessagesCollection.pas,v 1.15 2011/12/08 16:30:03 lulin Exp $ }
...
(*    {$IfDef DesignTimeLibrary}
    private
    // private fields
      f_Categories : IvcmStrings;
    protected
    // protected methods
      function pm_GetCategories : IvcmStrings;
        {-}
      procedure Cleanup;
        override;
        {-}
...
(*    {$IfDef DesignTimeLibrary}
    public
    // public properties
      property Categories : IvcmStrings
...
(*{$IfDef DesignTimeLibrary}
function TvcmMessagesCollection.pm_GetCategories: IvcmStrings;
  {-}
var
 lIndex : Integer;
begin
