...
{ $Id: vcmBaseUserTypesCollectionItem.pas,v 1.20 2013/07/05 14:34:52 lulin Exp $ }
...
function TvcmBaseUserTypesCollectionItem.CaptionStored: Boolean;
  //override;
  {-}
begin
 Result := false;
...
begin
  // http://mdp.garant.ru/pages/viewpage.action?pageId=466760570
  Result := f_AllowCustomizeToolbars {or afw.Application.IsInternal};
