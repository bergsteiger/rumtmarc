...
{ $Id: vcmZonesCollectionItem.pas,v 1.106 2013/01/22 15:52:24 kostitsin Exp $ }
...
// - new method: IvcmContainer._HasForm.
//
...
begin
 ...
 begin
  ...
  if (l_Form Is TvcmContainerForm) AND
   not TvcmContainerForm(l_Form).Zones.AcceptForm(TvcmEntityForm(DockClient).As_IvcmEntityForm, TComponent(Sender)) then
   CanDock := false;
