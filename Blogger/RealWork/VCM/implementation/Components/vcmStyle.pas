...
// Начат      : 12.12.2006
// Версия     : $Id: vcmStyle.pas,v 1.4 2011/05/19 12:21:15 lulin Exp $
...
type
  TvcmToolbarStyle = class(Tl3CBase, IvcmToolbarStyle)
  private
  // fields
  ...
  TvcmToolbarsStyle = class(Tl3CBase, IvcmToolbarsStyle)
  {* Иконки зоны. }
  private
  // fields
  ...
  TvcmFormStyle = class(Tl3CBase, IvcmFormStyle)
  private
  // fields
