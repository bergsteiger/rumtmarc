...
{ $Id: vcmEntitiesCollectionItem.pas,v 1.21 2013/04/25 14:22:38 lulin Exp $ }
...
function TvcmEntitiesCollectionItem.CaptionStored: Boolean;
  //override;
  {-}
begin
 if (f_Rep = nil) then
...
function TvcmEntitiesCollectionItem.OperationsStored: Boolean;
  //override;
  {-}
begin
 Result := inherited OperationsStored;
 if Result then
