...
{ $Id: vcmSettings.pas,v 1.120 2013/05/21 08:14:13 lulin Exp $ }
...
// - new methods: IafwSettings.AddListner, RemoveListner.
//
...
begin
 ...
 begin
  vcmCatPath(aPath, cWidth, l_Path);
  vcmSaveIntParamS(l_Path, aControl.Width);
 end;//..Width..
 if (aControl.Height > aControl.Constraints.MinHeight + 5) then
 begin
  vcmCatPath(aPath, cHeight, l_Path);
  vcmSaveIntParamS(l_Path, aControl.Height);
 end;//..Height..
end;
