...
{ $Id: vcmInternalInterfaces.pas,v 1.8 2012/04/13 14:37:25 lulin Exp $ }
...
// - change: свойство IvcmContainer.GUID переехало в IvcmEntityForm.GUID - теперь кажда€ форма имеет свой идентификатор.
