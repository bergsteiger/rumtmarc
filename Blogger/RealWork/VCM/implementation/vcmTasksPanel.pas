...
// Начат      : 22.02.2007                     
// Версия     : $Id: vcmTasksPanel.pas,v 1.115 2012/11/23 08:23:37 kostitsin Exp $
...
type
  ...
  public
  // methods
    function OCompare(anObject: TObject): Integer;
      override;
...
function TvcmCustOpsItem.OCompare(anObject: TObject): Integer;
begin
