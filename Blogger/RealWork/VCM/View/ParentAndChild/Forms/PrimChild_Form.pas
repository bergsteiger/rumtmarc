...
type
  ...
  Tkw_PrimChild_Control_ChildZone = class(TtfwControlString)
...
[code] }
  ...
  // overridden protected methods
   ...
   function GetString: AnsiString; override;
    {$IfEnd} //not NoScripts
  end;//Tkw_PrimChild_Control_ChildZone

// start class Tkw_PrimChild_Control_ChildZone

{$If not defined(NoScripts)}
function Tkw_PrimChild_Control_ChildZone.GetString: AnsiString;
 {-}
begin
 Result := 'ChildZone';
end;//Tkw_PrimChild_Control_ChildZone.GetString
{$IfEnd} //not NoScripts

type
  Tkw_PrimChild_Control_ChildZone_Push = class(TkwBynameControlPush)
...
[code] }
  ...
  // overridden protected methods
   ...
   procedure DoDoIt(const aCtx: TtfwContext); override;
    {$IfEnd} //not NoScripts
  end;//Tkw_PrimChild_Control_ChildZone_Push

// start class Tkw_PrimChild_Control_ChildZone_Push

{$If not defined(NoScripts)}
procedure Tkw_PrimChild_Control_ChildZone_Push.DoDoIt(const aCtx: TtfwContext);
 {-}
begin
 aCtx.rEngine.PushString('ChildZone');
 inherited;
end;//Tkw_PrimChild_Control_ChildZone_Push.DoDoIt
{$IfEnd} //not NoScripts

type
  Tkw_PrimChild_Control_MainPageTab = class(TtfwControlString)
...
[code] }
  ...
  // overridden protected methods
   ...
   function GetString: AnsiString; override;
    {$IfEnd} //not NoScripts
  end;//Tkw_PrimChild_Control_MainPageTab

// start class Tkw_PrimChild_Control_MainPageTab

{$If not defined(NoScripts)}
function Tkw_PrimChild_Control_MainPageTab.GetString: AnsiString;
 {-}
begin
 Result := 'MainPageTab';
end;//Tkw_PrimChild_Control_MainPageTab.GetString
{$IfEnd} //not NoScripts

type
  Tkw_PrimChild_Control_MainPageTab_Push = class(TkwBynameControlPush)
...
[code] }
  ...
  // overridden protected methods
   ...
   procedure DoDoIt(const aCtx: TtfwContext); override;
    {$IfEnd} //not NoScripts
  end;//Tkw_PrimChild_Control_MainPageTab_Push

// start class Tkw_PrimChild_Control_MainPageTab_Push

{$If not defined(NoScripts)}
procedure Tkw_PrimChild_Control_MainPageTab_Push.DoDoIt(const aCtx: TtfwContext);
 {-}
begin
 aCtx.rEngine.PushString('MainPageTab');
 inherited;
end;//Tkw_PrimChild_Control_MainPageTab_Push.DoDoIt
{$IfEnd} //not NoScripts
...
//#UC START# *4F71E2050390_4F6B6646037F_impl*
 if (Align = alClient) and
    ...
    (ANewHeight > f_ParentMinHeight) then
 begin
...
initialization
// Регистрация Tkw_PrimChild_Control_ChildZone
 Tkw_PrimChild_Control_ChildZone.Register('контрол::ChildZone', TnscFormsPageControl);
// Регистрация Tkw_PrimChild_Control_ChildZone_Push
 Tkw_PrimChild_Control_ChildZone_Push.Register('контрол::ChildZone:push');
// Регистрация Tkw_PrimChild_Control_MainPageTab
 Tkw_PrimChild_Control_MainPageTab.Register('контрол::MainPageTab', TElTabSheet);
// Регистрация Tkw_PrimChild_Control_MainPageTab_Push
 Tkw_PrimChild_Control_MainPageTab_Push.Register('контрол::MainPageTab:push');
