...
// Generated from UML model, root element: <<VCMFormsPack::Class>> Shared Delphi F1 Like Application::F1Like::View::ParentAndChild::ParentAndChild
//
...
type
 Tmo_ParentAndChild = {final formspack} class(TParentAndChildPrimModule)
  {* Поддержка работы с родительской и дочерней зонами }
