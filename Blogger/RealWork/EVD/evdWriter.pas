...
{ $Id: evdWriter.pas,v 1.61 2013/04/05 16:44:16 lulin Exp $ }
...
procedure TevdCustomNativeWriter.OutEndBinary;
  {-}
begin
...
function TevdCustomNativeWriter.WriteString(S : Tl3PrimString): Long;
  {-}
var
 l_S : Tl3WString;
 l_CharSize : Long;
...
procedure TevdCustomNativeWriter.StartChild(TypeID: Long);
  {override;}
  {-}
begin
 inherited;
...
procedure TevdCustomNativeWriter.DoStartChild(TypeID: Long);
  //virtual;
  {-}
begin
...
procedure TevdCustomNativeWriter.WriteStartChild(TypeID: Long);
  {-}
var
 TT : Tk2TypePrim;
begin
...
procedure TevdCustomNativeWriter.OutObject(AtomIndex: Long; O: Tl3PrimString);
  {-}
var
 l_Index    : Long;
...
procedure TevdCustomNativeWriter.AddAtomEx(AtomIndex: Long; const Value: Tk2Variant);
  {override;}
  {-}
begin
...
procedure TevdCustomNativeWriter.WriteAtom(AtomIndex: Long; const Value: Tk2Variant);
  {-}
var
 l_AT   : Tk2TypePrim;
 l_Prop : Tk2CustomPropertyPrim;
