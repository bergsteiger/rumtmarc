...
{ $Id: evdXMLReader.pas,v 1.16 2010/11/30 11:47:10 lulin Exp $ }
...
begin
 ...
 begin
  ...
  begin
   l_CT := CurrentType;
   if l_CT.InheritsFrom(k2_idTextPara) OR l_CT.InheritsFrom(k2_idSegment) then
    try
