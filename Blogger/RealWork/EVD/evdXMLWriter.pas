...
{ $Id: evdXMLWriter.pas,v 1.17 2012/08/30 13:37:58 kostitsin Exp $ }
...
procedure TevdXMLWriter.StartChild(TypeID: Integer);
  //override;
  {-}
var
 l_O : Tk2Type;
  ...
  Case Value.Kind of
   ...
   begin
    ...
    Case l_AT.AtomType^.Kind of
     tkInteger,
     tkEnumeration:
      l_Value := f_Writer.CS(l_AT.IntToTag(Value.AsInteger).AsString);
     else
