...
type
 ...
 public
 // public methods
   class function MarkModified(const aTag: Ik2Tag): Boolean; virtual;
...
class function TevdParaModifier.MarkModified(const aTag: Ik2Tag): Boolean;
...
function WevPara.MarkModified(const aTag: Ik2Tag): Boolean;
